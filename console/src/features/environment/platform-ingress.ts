...
import { routerProjection } from "@/lib/components";

function hasCompleteRouterProjection(
  project: NonNullable<Project["environments"]>[number],
) {
  return (
    project.components.some((component) => component.kind === "caddy") &&
