...
func file_proto_agent_proto_init() {
	...
	file_proto_agent_proto_msgTypes[81].OneofWrappers = []any{
	...
	file_proto_agent_proto_msgTypes[110].OneofWrappers = []any{
	...
	file_proto_agent_proto_msgTypes[119].OneofWrappers = []any{
