...
func (x *ControllerMessage) GetLogCredit() *LogCredit {
	if x != nil {
		if x, ok := x.Payload.(*ControllerMessage_LogCredit); ok {
			return x.LogCredit
		}
	}
	return nil
...
type ControllerMessage_LogCredit struct {
	LogCredit *LogCredit `protobuf:"bytes,17,opt,name=log_credit,json=logCredit,proto3,oneof"`
}
...
func (*ControllerMessage_LogCredit) isControllerMessage_Payload() {}
...
type LogSubscribe struct {
	...
	InitialCredit uint32                 `protobuf:"varint,5,opt,name=initial_credit,json=initialCredit,proto3" json:"initial_credit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LogSubscribe) GetInitialCredit() uint32 {
	if x != nil {
...
func (x *LogCredit) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *LogCredit) GetCount() uint32 {
	if x != nil {
		return x.Count
	}
	return 0
...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\x0einitial_credit\x18\x05 \x01(\rR\rinitialCredit\"*\n" +
	"\tLogCancel\x12\x1d\n" +
	"\n" +
