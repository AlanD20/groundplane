...
type WorkloadImageResolutionFailureKind int32

const (
	WorkloadImageResolutionFailureKind_WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_UNSPECIFIED        WorkloadImageResolutionFailureKind = 0
	WorkloadImageResolutionFailureKind_WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_NOT_FOUND          WorkloadImageResolutionFailureKind = 1
	WorkloadImageResolutionFailureKind_WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_IDENTITY_MISMATCH  WorkloadImageResolutionFailureKind = 2
	WorkloadImageResolutionFailureKind_WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_OBSERVATION_FAILED WorkloadImageResolutionFailureKind = 3
)

// Enum value maps for WorkloadImageResolutionFailureKind.
var (
	WorkloadImageResolutionFailureKind_name = map[int32]string{
		0: "WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_UNSPECIFIED",
		1: "WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_NOT_FOUND",
		2: "WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_IDENTITY_MISMATCH",
		3: "WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_OBSERVATION_FAILED",
	}
	WorkloadImageResolutionFailureKind_value = map[string]int32{
...
func (x WorkloadImageResolutionFailureKind) Enum() *WorkloadImageResolutionFailureKind {
	p := new(WorkloadImageResolutionFailureKind)
	*p = x
	return p
}

func (x WorkloadImageResolutionFailureKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WorkloadImageResolutionFailureKind) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_agent_proto_enumTypes[0].Descriptor()
}

func (WorkloadImageResolutionFailureKind) Type() protoreflect.EnumType {
	return &file_proto_agent_proto_enumTypes[0]
}

func (x WorkloadImageResolutionFailureKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use WorkloadImageResolutionFailureKind.Descriptor instead.
func (WorkloadImageResolutionFailureKind) EnumDescriptor() ([]byte, []int) {
...
const (
	ReleaseRecoveryPhase_RELEASE_RECOVERY_PHASE_UNSPECIFIED ReleaseRecoveryPhase = 0
	ReleaseRecoveryPhase_RELEASE_RECOVERY_PHASE_PROBE       ReleaseRecoveryPhase = 1
	ReleaseRecoveryPhase_RELEASE_RECOVERY_PHASE_COMPENSATE  ReleaseRecoveryPhase = 2
	ReleaseRecoveryPhase_RELEASE_RECOVERY_PHASE_PROVEN      ReleaseRecoveryPhase = 3
)

// Enum value maps for ReleaseRecoveryPhase.
var (
	ReleaseRecoveryPhase_name = map[int32]string{
		0: "RELEASE_RECOVERY_PHASE_UNSPECIFIED",
		1: "RELEASE_RECOVERY_PHASE_PROBE",
		2: "RELEASE_RECOVERY_PHASE_COMPENSATE",
		3: "RELEASE_RECOVERY_PHASE_PROVEN",
	}
	ReleaseRecoveryPhase_value = map[string]int32{
...
func (x ReleaseRecoveryPhase) Enum() *ReleaseRecoveryPhase {
	p := new(ReleaseRecoveryPhase)
	*p = x
	return p
}

func (x ReleaseRecoveryPhase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
const (
	TaskExecutionMode_TASK_EXECUTION_MODE_UNSPECIFIED   TaskExecutionMode = 0
	TaskExecutionMode_TASK_EXECUTION_MODE_FORWARD       TaskExecutionMode = 1
	TaskExecutionMode_TASK_EXECUTION_MODE_RECOVERY_ONLY TaskExecutionMode = 2
)

// Enum value maps for TaskExecutionMode.
var (
	TaskExecutionMode_name = map[int32]string{
		0: "TASK_EXECUTION_MODE_UNSPECIFIED",
		1: "TASK_EXECUTION_MODE_FORWARD",
		2: "TASK_EXECUTION_MODE_RECOVERY_ONLY",
	}
	TaskExecutionMode_value = map[string]int32{
...
func (x TaskExecutionMode) Enum() *TaskExecutionMode {
	p := new(TaskExecutionMode)
	*p = x
	return p
}

func (x TaskExecutionMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
const (
	ReleaseRestorationTarget_RELEASE_RESTORATION_TARGET_UNSPECIFIED         ReleaseRestorationTarget = 0
	ReleaseRestorationTarget_RELEASE_RESTORATION_TARGET_SERVING_PREDECESSOR ReleaseRestorationTarget = 1
	ReleaseRestorationTarget_RELEASE_RESTORATION_TARGET_CANDIDATE_ABSENCE   ReleaseRestorationTarget = 2
)

// Enum value maps for ReleaseRestorationTarget.
var (
	ReleaseRestorationTarget_name = map[int32]string{
		0: "RELEASE_RESTORATION_TARGET_UNSPECIFIED",
		1: "RELEASE_RESTORATION_TARGET_SERVING_PREDECESSOR",
		2: "RELEASE_RESTORATION_TARGET_CANDIDATE_ABSENCE",
	}
	ReleaseRestorationTarget_value = map[string]int32{
...
func (x ReleaseRestorationTarget) Enum() *ReleaseRestorationTarget {
	p := new(ReleaseRestorationTarget)
	*p = x
	return p
}

func (x ReleaseRestorationTarget) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type BackingHookEvent int32

const (
	BackingHookEvent_BACKING_HOOK_EVENT_UNSPECIFIED BackingHookEvent = 0
	BackingHookEvent_BACKING_HOOK_EVENT_ATTACH      BackingHookEvent = 1
	BackingHookEvent_BACKING_HOOK_EVENT_DETACH      BackingHookEvent = 2
	BackingHookEvent_BACKING_HOOK_EVENT_BEFORE_STOP BackingHookEvent = 3
	BackingHookEvent_BACKING_HOOK_EVENT_AFTER_START BackingHookEvent = 4
)

// Enum value maps for BackingHookEvent.
var (
	BackingHookEvent_name = map[int32]string{
		0: "BACKING_HOOK_EVENT_UNSPECIFIED",
		1: "BACKING_HOOK_EVENT_ATTACH",
		2: "BACKING_HOOK_EVENT_DETACH",
		3: "BACKING_HOOK_EVENT_BEFORE_STOP",
		4: "BACKING_HOOK_EVENT_AFTER_START",
	}
	BackingHookEvent_value = map[string]int32{
		"BACKING_HOOK_EVENT_UNSPECIFIED": 0,
		"BACKING_HOOK_EVENT_ATTACH":      1,
		"BACKING_HOOK_EVENT_DETACH":      2,
		"BACKING_HOOK_EVENT_BEFORE_STOP": 3,
		"BACKING_HOOK_EVENT_AFTER_START": 4,
	}
)

func (x BackingHookEvent) Enum() *BackingHookEvent {
	p := new(BackingHookEvent)
	*p = x
	return p
}

func (x BackingHookEvent) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BackingHookEvent) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_agent_proto_enumTypes[16].Descriptor()
}

func (BackingHookEvent) Type() protoreflect.EnumType {
	return &file_proto_agent_proto_enumTypes[16]
}

func (x BackingHookEvent) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BackingHookEvent.Descriptor instead.
func (BackingHookEvent) EnumDescriptor() ([]byte, []int) {
	return file_proto_agent_proto_rawDescGZIP(), []int{16}
}

type BackingHookCheckpointState int32

const (
	BackingHookCheckpointState_BACKING_HOOK_CHECKPOINT_STATE_UNSPECIFIED BackingHookCheckpointState = 0
	BackingHookCheckpointState_BACKING_HOOK_CHECKPOINT_STATE_STARTED     BackingHookCheckpointState = 1
	BackingHookCheckpointState_BACKING_HOOK_CHECKPOINT_STATE_RESULT      BackingHookCheckpointState = 2
)

// Enum value maps for BackingHookCheckpointState.
var (
	BackingHookCheckpointState_name = map[int32]string{
		0: "BACKING_HOOK_CHECKPOINT_STATE_UNSPECIFIED",
		1: "BACKING_HOOK_CHECKPOINT_STATE_STARTED",
		2: "BACKING_HOOK_CHECKPOINT_STATE_RESULT",
	}
	BackingHookCheckpointState_value = map[string]int32{
		"BACKING_HOOK_CHECKPOINT_STATE_UNSPECIFIED": 0,
		"BACKING_HOOK_CHECKPOINT_STATE_STARTED":     1,
		"BACKING_HOOK_CHECKPOINT_STATE_RESULT":      2,
	}
)

func (x BackingHookCheckpointState) Enum() *BackingHookCheckpointState {
	p := new(BackingHookCheckpointState)
	*p = x
	return p
}

func (x BackingHookCheckpointState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BackingHookCheckpointState) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_agent_proto_enumTypes[17].Descriptor()
}

func (BackingHookCheckpointState) Type() protoreflect.EnumType {
	return &file_proto_agent_proto_enumTypes[17]
}

func (x BackingHookCheckpointState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BackingHookCheckpointState.Descriptor instead.
func (BackingHookCheckpointState) EnumDescriptor() ([]byte, []int) {
...
type BackingAuthentication int32

const (
	BackingAuthentication_BACKING_AUTHENTICATION_UNSPECIFIED       BackingAuthentication = 0
	BackingAuthentication_BACKING_AUTHENTICATION_USERNAME_PASSWORD BackingAuthentication = 1
	BackingAuthentication_BACKING_AUTHENTICATION_PASSWORD          BackingAuthentication = 2
	BackingAuthentication_BACKING_AUTHENTICATION_NONE              BackingAuthentication = 3
)

// Enum value maps for BackingAuthentication.
var (
	BackingAuthentication_name = map[int32]string{
		0: "BACKING_AUTHENTICATION_UNSPECIFIED",
		1: "BACKING_AUTHENTICATION_USERNAME_PASSWORD",
		2: "BACKING_AUTHENTICATION_PASSWORD",
		3: "BACKING_AUTHENTICATION_NONE",
	}
	BackingAuthentication_value = map[string]int32{
...
func (x BackingAuthentication) Enum() *BackingAuthentication {
	p := new(BackingAuthentication)
	*p = x
	return p
}

func (x BackingAuthentication) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
const (
	...
	ComposeHelperOutcome_COMPOSE_HELPER_OUTCOME_RESTORATION_REQUIRED ComposeHelperOutcome = 3
)
...
var (
	ComposeHelperOutcome_name = map[int32]string{
		...
		3: "COMPOSE_HELPER_OUTCOME_RESTORATION_REQUIRED",
	}
...
type AgentMessage struct {
	...
	//	*AgentMessage_WorkloadImageResolutionResult
...
func (x *AgentMessage) GetWorkloadImageResolutionResult() *WorkloadImageResolutionResult {
	if x != nil {
		if x, ok := x.Payload.(*AgentMessage_WorkloadImageResolutionResult); ok {
			return x.WorkloadImageResolutionResult
		}
	}
	return nil
}

func (x *AgentMessage) GetVolumeRemovalCheckpointRequest() *VolumeRemovalCheckpointRequest {
	if x != nil {
		if x, ok := x.Payload.(*AgentMessage_VolumeRemovalCheckpointRequest); ok {
			return x.VolumeRemovalCheckpointRequest
		}
	}
	return nil
}

func (x *AgentMessage) GetServiceObservationResult() *ServiceObservationResult {
	if x != nil {
		if x, ok := x.Payload.(*AgentMessage_ServiceObservationResult); ok {
			return x.ServiceObservationResult
		}
	}
	return nil
}

func (x *AgentMessage) GetBackingHookCheckpointRequest() *BackingHookCheckpointRequest {
	if x != nil {
		if x, ok := x.Payload.(*AgentMessage_BackingHookCheckpointRequest); ok {
			return x.BackingHookCheckpointRequest
		}
	}
	return nil
}
...
type AgentMessage_WorkloadImageResolutionResult struct {
	WorkloadImageResolutionResult *WorkloadImageResolutionResult `protobuf:"bytes,11,opt,name=workload_image_resolution_result,json=workloadImageResolutionResult,proto3,oneof"`
}

type AgentMessage_VolumeRemovalCheckpointRequest struct {
	VolumeRemovalCheckpointRequest *VolumeRemovalCheckpointRequest `protobuf:"bytes,12,opt,name=volume_removal_checkpoint_request,json=volumeRemovalCheckpointRequest,proto3,oneof"`
}

type AgentMessage_ServiceObservationResult struct {
	ServiceObservationResult *ServiceObservationResult `protobuf:"bytes,13,opt,name=service_observation_result,json=serviceObservationResult,proto3,oneof"`
}

type AgentMessage_BackingHookCheckpointRequest struct {
...
func (*AgentMessage_WorkloadImageResolutionResult) isAgentMessage_Payload() {}

func (*AgentMessage_VolumeRemovalCheckpointRequest) isAgentMessage_Payload() {}

func (*AgentMessage_ServiceObservationResult) isAgentMessage_Payload() {}
...
type WorkloadImageSelector struct {
	...
	//
	//	*WorkloadImageSelector_RequestedReference
	//	*WorkloadImageSelector_LocalImageId
	Selector      isWorkloadImageSelector_Selector `protobuf_oneof:"selector"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkloadImageSelector) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkloadImageSelector) GetRequestedReference() string {
	if x != nil {
		if x, ok := x.Selector.(*WorkloadImageSelector_RequestedReference); ok {
			return x.RequestedReference
		}
	}
	return ""
}

func (x *WorkloadImageSelector) GetLocalImageId() string {
	if x != nil {
		if x, ok := x.Selector.(*WorkloadImageSelector_LocalImageId); ok {
			return x.LocalImageId
		}
	}
	return ""
}

type isWorkloadImageSelector_Selector interface {
	isWorkloadImageSelector_Selector()
}

type WorkloadImageSelector_RequestedReference struct {
	RequestedReference string `protobuf:"bytes,1,opt,name=requested_reference,json=requestedReference,proto3,oneof"`
}

type WorkloadImageSelector_LocalImageId struct {
	LocalImageId string `protobuf:"bytes,2,opt,name=local_image_id,json=localImageId,proto3,oneof"`
}

func (*WorkloadImageSelector_RequestedReference) isWorkloadImageSelector_Selector() {}

func (*WorkloadImageSelector_LocalImageId) isWorkloadImageSelector_Selector() {}

type ResolveWorkloadImages struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	RequestId     string                   `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	Selectors     []*WorkloadImageSelector `protobuf:"bytes,2,rep,name=selectors,proto3" json:"selectors,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResolveWorkloadImages) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ResolveWorkloadImages) GetSelectors() []*WorkloadImageSelector {
	if x != nil {
		return x.Selectors
	}
	return nil
...
type WorkloadImageResolution struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Selector      *WorkloadImageSelector `protobuf:"bytes,1,opt,name=selector,proto3" json:"selector,omitempty"`
	LocalImageId  string                 `protobuf:"bytes,2,opt,name=local_image_id,json=localImageId,proto3" json:"local_image_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkloadImageResolution) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkloadImageResolution) GetLocalImageId() string {
	if x != nil {
		return x.LocalImageId
	}
	return ""
...
type WorkloadImageResolutions struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	Resolutions   []*WorkloadImageResolution `protobuf:"bytes,1,rep,name=resolutions,proto3" json:"resolutions,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkloadImageResolutions) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type WorkloadImageResolutionFailure struct {
	state           protoimpl.MessageState             `protogen:"open.v1"`
	SelectorOrdinal *uint32                            `protobuf:"varint,1,opt,name=selector_ordinal,json=selectorOrdinal,proto3,oneof" json:"selector_ordinal,omitempty"`
	Kind            WorkloadImageResolutionFailureKind `protobuf:"varint,2,opt,name=kind,proto3,enum=groundplane.agent.v1.WorkloadImageResolutionFailureKind" json:"kind,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *WorkloadImageResolutionFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkloadImageResolutionFailure) GetSelectorOrdinal() uint32 {
	if x != nil && x.SelectorOrdinal != nil {
		return *x.SelectorOrdinal
	}
	return 0
}

func (x *WorkloadImageResolutionFailure) GetKind() WorkloadImageResolutionFailureKind {
	if x != nil {
		return x.Kind
	}
	return WorkloadImageResolutionFailureKind_WORKLOAD_IMAGE_RESOLUTION_FAILURE_KIND_UNSPECIFIED
}

type WorkloadImageResolutionResult struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	RequestId string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	// Types that are valid to be assigned to Outcome:
	//
	//	*WorkloadImageResolutionResult_Success
	//	*WorkloadImageResolutionResult_Failure
	Outcome       isWorkloadImageResolutionResult_Outcome `protobuf_oneof:"outcome"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkloadImageResolutionResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkloadImageResolutionResult) GetOutcome() isWorkloadImageResolutionResult_Outcome {
	if x != nil {
		return x.Outcome
	}
	return nil
...
func (x *WorkloadImageResolutionResult) GetSuccess() *WorkloadImageResolutions {
	if x != nil {
		if x, ok := x.Outcome.(*WorkloadImageResolutionResult_Success); ok {
			return x.Success
		}
	}
	return nil
...
func (x *WorkloadImageResolutionResult) GetFailure() *WorkloadImageResolutionFailure {
	if x != nil {
		if x, ok := x.Outcome.(*WorkloadImageResolutionResult_Failure); ok {
			return x.Failure
		}
	}
	return nil
...
type isWorkloadImageResolutionResult_Outcome interface {
	isWorkloadImageResolutionResult_Outcome()
}

type WorkloadImageResolutionResult_Success struct {
	Success *WorkloadImageResolutions `protobuf:"bytes,2,opt,name=success,proto3,oneof"`
}

type WorkloadImageResolutionResult_Failure struct {
	Failure *WorkloadImageResolutionFailure `protobuf:"bytes,3,opt,name=failure,proto3,oneof"`
}

func (*WorkloadImageResolutionResult_Success) isWorkloadImageResolutionResult_Outcome() {}

func (*WorkloadImageResolutionResult_Failure) isWorkloadImageResolutionResult_Outcome() {}
...
func (x *ServiceObservationTarget) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ServiceObservationTarget) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *ServiceObservationTarget) GetReleaseId() string {
	if x != nil {
		return x.ReleaseId
	}
	return ""
...
func (x *ServiceObservationTarget) GetPlanId() string {
	if x != nil {
		return x.PlanId
	}
	return ""
...
func (x *ServiceObservationTarget) GetRenderGeneration() uint64 {
	if x != nil {
...
func (x *ServiceObservationTarget) GetComposeName() string {
	if x != nil {
...
func (x *ServiceObservationTarget) GetRuntimeRole() string {
	if x != nil {
...
func (x *ServiceObservationTarget) GetSlot() string {
	if x != nil {
		return x.Slot
	}
	return ""
...
type ObserveServices struct {
	...
	Targets       []*ServiceObservationTarget `protobuf:"bytes,2,rep,name=targets,proto3" json:"targets,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ObserveServices) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ObserveServices) GetTargets() []*ServiceObservationTarget {
	if x != nil {
		return x.Targets
	}
	return nil
...
type CancelServiceObservation struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // cancel only this exchange on this connection
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CancelServiceObservation) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ServiceReplicaCounts struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Running       uint32                 `protobuf:"varint,1,opt,name=running,proto3" json:"running,omitempty"` // running without a healthcheck
	Healthy       uint32                 `protobuf:"varint,2,opt,name=healthy,proto3" json:"healthy,omitempty"`
	Starting      uint32                 `protobuf:"varint,3,opt,name=starting,proto3" json:"starting,omitempty"` // running with a starting healthcheck
	Unhealthy     uint32                 `protobuf:"varint,4,opt,name=unhealthy,proto3" json:"unhealthy,omitempty"`
	Transitional  uint32                 `protobuf:"varint,5,opt,name=transitional,proto3" json:"transitional,omitempty"` // created, paused, restarting or removing
	Stopped       uint32                 `protobuf:"varint,6,opt,name=stopped,proto3" json:"stopped,omitempty"`           // exited zero
	Failed        uint32                 `protobuf:"varint,7,opt,name=failed,proto3" json:"failed,omitempty"`             // dead or exited nonzero
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServiceReplicaCounts) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ServiceReplicaCounts) GetHealthy() uint32 {
	if x != nil {
		return x.Healthy
	}
	return 0
...
func (x *ServiceReplicaCounts) GetStarting() uint32 {
	if x != nil {
		return x.Starting
	}
	return 0
...
func (x *ServiceReplicaCounts) GetUnhealthy() uint32 {
	if x != nil {
		return x.Unhealthy
	}
	return 0
...
func (x *ServiceReplicaCounts) GetTransitional() uint32 {
	if x != nil {
...
func (x *ServiceReplicaCounts) GetStopped() uint32 {
	if x != nil {
		return x.Stopped
	}
	return 0
...
func (x *ServiceReplicaCounts) GetFailed() uint32 {
	if x != nil {
		return x.Failed
	}
	return 0
...
type ServiceObservationRow struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ServiceObservationRow) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ServiceObservationRow) GetReleaseId() string {
	if x != nil {
		return x.ReleaseId
	}
	return ""
...
func (x *ServiceObservationRow) GetOutcome() isServiceObservationRow_Outcome {
	if x != nil {
		return x.Outcome
	}
	return nil
...
func (x *ServiceObservationRow) GetReplicas() *ServiceReplicaCounts {
	if x != nil {
		if x, ok := x.Outcome.(*ServiceObservationRow_Replicas); ok {
			return x.Replicas
		}
	}
	return nil
...
func (x *ServiceObservationRow) GetUnavailable() bool {
	if x != nil {
		if x, ok := x.Outcome.(*ServiceObservationRow_Unavailable); ok {
...
type ServiceObservationRow_Replicas struct {
	Replicas *ServiceReplicaCounts `protobuf:"bytes,3,opt,name=replicas,proto3,oneof"`
}

type ServiceObservationRow_Unavailable struct {
	Unavailable bool `protobuf:"varint,4,opt,name=unavailable,proto3,oneof"` // must be true; no partial counts or diagnostic text
}

func (*ServiceObservationRow_Replicas) isServiceObservationRow_Outcome() {}
...
type ServiceObservationResult struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	RequestId     string                   `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	Observations  []*ServiceObservationRow `protobuf:"bytes,2,rep,name=observations,proto3" json:"observations,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServiceObservationResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ServiceObservationResult) GetObservations() []*ServiceObservationRow {
	if x != nil {
...
type TaskEvent struct {
	...
	ExecutionEpoch uint32                 `protobuf:"varint,4,opt,name=execution_epoch,json=executionEpoch,proto3" json:"execution_epoch,omitempty"` // exact durable assignment execution epoch
...
func (x *TaskEvent) GetExecutionEpoch() uint32 {
	if x != nil {
...
type TaskEventAck struct {
	...
	StepId         string                 `protobuf:"bytes,3,opt,name=step_id,json=stepId,proto3" json:"step_id,omitempty"`
	ExecutionEpoch uint32                 `protobuf:"varint,4,opt,name=execution_epoch,json=executionEpoch,proto3" json:"execution_epoch,omitempty"`
...
func (x *TaskEventAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TaskEventAck) GetPlanHash() []byte {
	if x != nil {
		return x.PlanHash
	}
	return nil
...
func (x *TaskEventAck) GetStepId() string {
	if x != nil {
		return x.StepId
	}
	return ""
...
func (x *TaskEventAck) GetExecutionEpoch() uint32 {
	if x != nil {
		return x.ExecutionEpoch
	}
	return 0
...
func (x *TaskEventAck) GetOrdinal() uint64 {
	if x != nil {
		return x.Ordinal
	}
	return 0
...
func (x *TaskEventAck) GetState() TaskState {
	if x != nil {
		return x.State
	}
	return TaskState_TASK_STATE_UNSPECIFIED
...
func (x *TaskEventAck) GetAssignmentId() string {
	if x != nil {
		return x.AssignmentId
	}
	return ""
...
type ObservedCollision struct {
	...
	Name               string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	ComposeServiceName string                 `protobuf:"bytes,3,opt,name=compose_service_name,json=composeServiceName,proto3" json:"compose_service_name,omitempty"`
...
func (x *ObservedCollision) GetComposeServiceName() string {
	if x != nil {
		return x.ComposeServiceName
	}
	return ""
}

func (x *ObservedCollision) GetComponentId() string {
	if x != nil {
...
func (x *ObservedCollision) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *TaskAck) GetExecutionEpoch() uint32 {
	if x != nil {
		return x.ExecutionEpoch
	}
	return 0
...
func (x *TaskAck) GetReleaseRecoveryRecordSha256() []byte {
	if x != nil {
		return x.ReleaseRecoveryRecordSha256
	}
	return nil
}
...
type ComposeTaskResult struct {
	...
	CandidateAbsenceEvidence        *CandidateAbsenceEvidence       `protobuf:"bytes,9,opt,name=candidate_absence_evidence,json=candidateAbsenceEvidence,proto3" json:"candidate_absence_evidence,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *ComposeTaskResult) GetCandidateAbsenceEvidence() *CandidateAbsenceEvidence {
	if x != nil {
		return x.CandidateAbsenceEvidence
	}
	return nil
}

type CandidateAbsenceEvidence struct {
	state               protoimpl.MessageState     `protogen:"open.v1"`
	AssignmentId        string                     `protobuf:"bytes,1,opt,name=assignment_id,json=assignmentId,proto3" json:"assignment_id,omitempty"`
	PlanHash            []byte                     `protobuf:"bytes,2,opt,name=plan_hash,json=planHash,proto3" json:"plan_hash,omitempty"`
	AuthoritySha256     []byte                     `protobuf:"bytes,3,opt,name=authority_sha256,json=authoritySha256,proto3" json:"authority_sha256,omitempty"`
	ComposeProjectName  string                     `protobuf:"bytes,4,opt,name=compose_project_name,json=composeProjectName,proto3" json:"compose_project_name,omitempty"`
	CandidateArtifactId string                     `protobuf:"bytes,5,opt,name=candidate_artifact_id,json=candidateArtifactId,proto3" json:"candidate_artifact_id,omitempty"`
	Candidates          []*CandidateReleaseService `protobuf:"bytes,6,rep,name=candidates,proto3" json:"candidates,omitempty"`
	AbsenceProven       bool                       `protobuf:"varint,7,opt,name=absence_proven,json=absenceProven,proto3" json:"absence_proven,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CandidateAbsenceEvidence) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CandidateAbsenceEvidence) GetPlanHash() []byte {
	if x != nil {
		return x.PlanHash
	}
	return nil
...
func (x *CandidateAbsenceEvidence) GetAuthoritySha256() []byte {
	if x != nil {
...
func (x *CandidateAbsenceEvidence) GetComposeProjectName() string {
	if x != nil {
...
func (x *CandidateAbsenceEvidence) GetCandidateArtifactId() string {
	if x != nil {
...
func (x *CandidateAbsenceEvidence) GetCandidates() []*CandidateReleaseService {
	if x != nil {
		return x.Candidates
	}
	return nil
...
func (x *CandidateAbsenceEvidence) GetAbsenceProven() bool {
	if x != nil {
		return x.AbsenceProven
	}
	return false
}
...
type ControllerMessage struct {
	...
	//	*ControllerMessage_ResolveWorkloadImages
	//	*ControllerMessage_VolumeRemovalCheckpointAck
	//	*ControllerMessage_ObserveServices
	//	*ControllerMessage_CancelServiceObservation
...
func (x *ControllerMessage) GetResolveWorkloadImages() *ResolveWorkloadImages {
	if x != nil {
		if x, ok := x.Payload.(*ControllerMessage_ResolveWorkloadImages); ok {
			return x.ResolveWorkloadImages
		}
	}
	return nil
}

func (x *ControllerMessage) GetVolumeRemovalCheckpointAck() *VolumeRemovalCheckpointAck {
	if x != nil {
		if x, ok := x.Payload.(*ControllerMessage_VolumeRemovalCheckpointAck); ok {
			return x.VolumeRemovalCheckpointAck
		}
	}
	return nil
}

func (x *ControllerMessage) GetObserveServices() *ObserveServices {
	if x != nil {
		if x, ok := x.Payload.(*ControllerMessage_ObserveServices); ok {
			return x.ObserveServices
		}
	}
	return nil
}

func (x *ControllerMessage) GetCancelServiceObservation() *CancelServiceObservation {
	if x != nil {
		if x, ok := x.Payload.(*ControllerMessage_CancelServiceObservation); ok {
			return x.CancelServiceObservation
		}
	}
	return nil
}

func (x *ControllerMessage) GetBackingHookCheckpointAck() *BackingHookCheckpointAck {
	if x != nil {
		if x, ok := x.Payload.(*ControllerMessage_BackingHookCheckpointAck); ok {
			return x.BackingHookCheckpointAck
		}
	}
	return nil
}

func (x *ControllerMessage) GetTaskEventAck() *TaskEventAck {
	if x != nil {
		if x, ok := x.Payload.(*ControllerMessage_TaskEventAck); ok {
			return x.TaskEventAck
		}
	}
	return nil
}
...
type ControllerMessage_ResolveWorkloadImages struct {
	ResolveWorkloadImages *ResolveWorkloadImages `protobuf:"bytes,12,opt,name=resolve_workload_images,json=resolveWorkloadImages,proto3,oneof"`
}

type ControllerMessage_VolumeRemovalCheckpointAck struct {
	VolumeRemovalCheckpointAck *VolumeRemovalCheckpointAck `protobuf:"bytes,13,opt,name=volume_removal_checkpoint_ack,json=volumeRemovalCheckpointAck,proto3,oneof"`
}

type ControllerMessage_ObserveServices struct {
	ObserveServices *ObserveServices `protobuf:"bytes,14,opt,name=observe_services,json=observeServices,proto3,oneof"`
}

type ControllerMessage_CancelServiceObservation struct {
	CancelServiceObservation *CancelServiceObservation `protobuf:"bytes,15,opt,name=cancel_service_observation,json=cancelServiceObservation,proto3,oneof"`
}

type ControllerMessage_BackingHookCheckpointAck struct {
	BackingHookCheckpointAck *BackingHookCheckpointAck `protobuf:"bytes,16,opt,name=backing_hook_checkpoint_ack,json=backingHookCheckpointAck,proto3,oneof"`
}

type ControllerMessage_TaskEventAck struct {
...
func (*ControllerMessage_ResolveWorkloadImages) isControllerMessage_Payload() {}

func (*ControllerMessage_VolumeRemovalCheckpointAck) isControllerMessage_Payload() {}

func (*ControllerMessage_ObserveServices) isControllerMessage_Payload() {}

func (*ControllerMessage_CancelServiceObservation) isControllerMessage_Payload() {}

func (*ControllerMessage_BackingHookCheckpointAck) isControllerMessage_Payload() {}
...
type TaskAssignment struct {
	...
	ForwardDeadline             *timestamppb.Timestamp       `protobuf:"bytes,7,opt,name=forward_deadline,json=forwardDeadline,proto3" json:"forward_deadline,omitempty"` // durable absolute forward deadline; reconnect never restarts the budget
	...
	RestorationAuthority        *ReleaseRestorationAuthority `protobuf:"bytes,19,opt,name=restoration_authority,json=restorationAuthority,proto3" json:"restoration_authority,omitempty"`
	ReleaseRecoveryRecordSha256 []byte                       `protobuf:"bytes,20,opt,name=release_recovery_record_sha256,json=releaseRecoveryRecordSha256,proto3" json:"release_recovery_record_sha256,omitempty"` // required only in recovery_only mode
	ReleaseRecoveryDirective    *ReleaseRecoveryDirective    `protobuf:"bytes,21,opt,name=release_recovery_directive,json=releaseRecoveryDirective,proto3" json:"release_recovery_directive,omitempty"`            // required only in recovery_only mode
	ExecutionDeadline           *timestamppb.Timestamp       `protobuf:"bytes,22,opt,name=execution_deadline,json=executionDeadline,proto3" json:"execution_deadline,omitempty"`                                   // current bounded attempt deadline; proof-required recovery uses a distinct non-renewable budget
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *TaskAssignment) GetForwardDeadline() *timestamppb.Timestamp {
	if x != nil {
		return x.ForwardDeadline
	}
	return nil
}
...
func (x *TaskAssignment) GetExecutionMode() TaskExecutionMode {
	if x != nil {
		return x.ExecutionMode
	}
	return TaskExecutionMode_TASK_EXECUTION_MODE_UNSPECIFIED
}

func (x *TaskAssignment) GetRecoveryDeadline() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TaskAssignment) GetRestorationAuthority() *ReleaseRestorationAuthority {
	if x != nil {
		return x.RestorationAuthority
	}
	return nil
}

func (x *TaskAssignment) GetReleaseRecoveryRecordSha256() []byte {
	if x != nil {
		return x.ReleaseRecoveryRecordSha256
	}
	return nil
...
func (x *TaskAssignment) GetReleaseRecoveryDirective() *ReleaseRecoveryDirective {
	if x != nil {
		return x.ReleaseRecoveryDirective
	}
	return nil
}

func (x *TaskAssignment) GetExecutionDeadline() *timestamppb.Timestamp {
	if x != nil {
...
type ReleaseRecoveryDirective struct {
	state                         protoimpl.MessageState `protogen:"open.v1"`
	StepIds                       []string               `protobuf:"bytes,1,rep,name=step_ids,json=stepIds,proto3" json:"step_ids,omitempty"`
	Cursor                        uint32                 `protobuf:"varint,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
	ReleaseRecoveryRecordSha256   []byte                 `protobuf:"bytes,3,opt,name=release_recovery_record_sha256,json=releaseRecoveryRecordSha256,proto3" json:"release_recovery_record_sha256,omitempty"`
	Phase                         ReleaseRecoveryPhase   `protobuf:"varint,4,opt,name=phase,proto3,enum=groundplane.agent.v1.ReleaseRecoveryPhase" json:"phase,omitempty"`
	ApplicableCompensationStepIds []string               `protobuf:"bytes,5,rep,name=applicable_compensation_step_ids,json=applicableCompensationStepIds,proto3" json:"applicable_compensation_step_ids,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *ReleaseRecoveryDirective) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReleaseRecoveryDirective) GetCursor() uint32 {
	if x != nil {
		return x.Cursor
	}
	return 0
...
func (x *ReleaseRecoveryDirective) GetReleaseRecoveryRecordSha256() []byte {
	if x != nil {
		return x.ReleaseRecoveryRecordSha256
	}
	return nil
...
func (x *ReleaseRecoveryDirective) GetPhase() ReleaseRecoveryPhase {
	if x != nil {
		return x.Phase
	}
	return ReleaseRecoveryPhase_RELEASE_RECOVERY_PHASE_UNSPECIFIED
}

func (x *ReleaseRecoveryDirective) GetApplicableCompensationStepIds() []string {
	if x != nil {
		return x.ApplicableCompensationStepIds
	}
	return nil
}
...
type ReleaseRestorationCandidate struct {
	...
	ServiceId     string                   `protobuf:"bytes,1,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	ReleaseId     string                   `protobuf:"bytes,2,opt,name=release_id,json=releaseId,proto3" json:"release_id,omitempty"`
	Target        ReleaseRestorationTarget `protobuf:"varint,3,opt,name=target,proto3,enum=groundplane.agent.v1.ReleaseRestorationTarget" json:"target,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReleaseRestorationCandidate) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReleaseRestorationCandidate) GetReleaseId() string {
	if x != nil {
		return x.ReleaseId
	}
	return ""
...
func (x *ReleaseRestorationCandidate) GetTarget() ReleaseRestorationTarget {
	if x != nil {
		return x.Target
	}
	return ReleaseRestorationTarget_RELEASE_RESTORATION_TARGET_UNSPECIFIED
}

type ReleaseAppliedPredecessorAuthority struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	KeyRevision           int64                  `protobuf:"varint,1,opt,name=key_revision,json=keyRevision,proto3" json:"key_revision,omitempty"`
	...
	ComposeArtifactSha256 []byte                 `protobuf:"bytes,4,opt,name=compose_artifact_sha256,json=composeArtifactSha256,proto3" json:"compose_artifact_sha256,omitempty"`
	ComposeArtifact       []byte                 `protobuf:"bytes,5,opt,name=compose_artifact,json=composeArtifact,proto3" json:"compose_artifact,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ReleaseAppliedPredecessorAuthority) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReleaseAppliedPredecessorAuthority) GetKeyRevision() int64 {
	if x != nil {
		return x.KeyRevision
	}
	return 0
}

func (x *ReleaseAppliedPredecessorAuthority) GetRevisionId() string {
	if x != nil {
		return x.RevisionId
	}
	return ""
...
func (x *ReleaseAppliedPredecessorAuthority) GetRenderGeneration() uint64 {
	if x != nil {
		return x.RenderGeneration
	}
	return 0
...
func (x *ReleaseAppliedPredecessorAuthority) GetComposeArtifactSha256() []byte {
	if x != nil {
		return x.ComposeArtifactSha256
	}
	return nil
}

func (x *ReleaseAppliedPredecessorAuthority) GetComposeArtifact() []byte {
	if x != nil {
		return x.ComposeArtifact
	}
	return nil
}
...
type ReleaseRestorationAuthority struct {
	...
	PlanHash            []byte                               `protobuf:"bytes,4,opt,name=plan_hash,json=planHash,proto3" json:"plan_hash,omitempty"`
	...
	Candidates          []*ReleaseRestorationCandidate       `protobuf:"bytes,7,rep,name=candidates,proto3" json:"candidates,omitempty"`
	AppliedPredecessor  *ReleaseAppliedPredecessorAuthority  `protobuf:"bytes,8,opt,name=applied_predecessor,json=appliedPredecessor,proto3" json:"applied_predecessor,omitempty"`
	AuthoritySha256     []byte                               `protobuf:"bytes,9,opt,name=authority_sha256,json=authoritySha256,proto3" json:"authority_sha256,omitempty"`
	NativePredecessors  []*ReleaseNativePredecessorAuthority `protobuf:"bytes,10,rep,name=native_predecessors,json=nativePredecessors,proto3" json:"native_predecessors,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ReleaseRestorationAuthority) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReleaseRestorationAuthority) GetOperationId() string {
	if x != nil {
		return x.OperationId
	}
	return ""
...
func (x *ReleaseRestorationAuthority) GetPlanHash() []byte {
	if x != nil {
		return x.PlanHash
	}
	return nil
...
func (x *ReleaseRestorationAuthority) GetEnvironmentId() string {
	if x != nil {
		return x.EnvironmentId
	}
	return ""
...
func (x *ReleaseRestorationAuthority) GetCandidateArtifactId() string {
	if x != nil {
		return x.CandidateArtifactId
	}
	return ""
...
func (x *ReleaseRestorationAuthority) GetCandidates() []*ReleaseRestorationCandidate {
	if x != nil {
		return x.Candidates
	}
	return nil
...
func (x *ReleaseRestorationAuthority) GetAppliedPredecessor() *ReleaseAppliedPredecessorAuthority {
	if x != nil {
		return x.AppliedPredecessor
	}
	return nil
}

func (x *ReleaseRestorationAuthority) GetAuthoritySha256() []byte {
	if x != nil {
		return x.AuthoritySha256
	}
	return nil
...
func (x *ReleaseRestorationAuthority) GetNativePredecessors() []*ReleaseNativePredecessorAuthority {
	if x != nil {
		return x.NativePredecessors
	}
	return nil
}
...
type ReleaseNativePredecessorAuthority struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	ServiceId             string                 `protobuf:"bytes,1,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	CurrentArtifact       []byte                 `protobuf:"bytes,2,opt,name=current_artifact,json=currentArtifact,proto3" json:"current_artifact,omitempty"`
	RetainedPriorArtifact []byte                 `protobuf:"bytes,3,opt,name=retained_prior_artifact,json=retainedPriorArtifact,proto3" json:"retained_prior_artifact,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ReleaseNativePredecessorAuthority) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReleaseNativePredecessorAuthority) GetCurrentArtifact() []byte {
	if x != nil {
		return x.CurrentArtifact
	}
	return nil
}

func (x *ReleaseNativePredecessorAuthority) GetRetainedPriorArtifact() []byte {
	if x != nil {
		return x.RetainedPriorArtifact
	}
	return nil
}
...
func (x *BackingHookValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BackingHookValue) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *BackingHookFactDefinition) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BackingHookFactDefinition) GetSecret() bool {
	if x != nil {
		return x.Secret
	}
	return false
...
// BackingHookProcedure is a frozen, task-private execution instruction. Values
// are transient on the authenticated Agent channel and are never persisted in
// the Task plan record.
type BackingHookProcedure struct {
	state            protoimpl.MessageState       `protogen:"open.v1"`
	Event            BackingHookEvent             `protobuf:"varint,1,opt,name=event,proto3,enum=groundplane.agent.v1.BackingHookEvent" json:"event,omitempty"`
	...
	AttachId         string                       `protobuf:"bytes,5,opt,name=attach_id,json=attachId,proto3" json:"attach_id,omitempty"`
	...
	Inputs           []*BackingHookValue          `protobuf:"bytes,10,rep,name=inputs,proto3" json:"inputs,omitempty"`
	Facts            []*BackingHookValue          `protobuf:"bytes,11,rep,name=facts,proto3" json:"facts,omitempty"`
	FactSchema       []*BackingHookFactDefinition `protobuf:"bytes,12,rep,name=fact_schema,json=factSchema,proto3" json:"fact_schema,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *BackingHookProcedure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BackingHookProcedure) GetEvent() BackingHookEvent {
	...
	return BackingHookEvent_BACKING_HOOK_EVENT_UNSPECIFIED
}

func (x *BackingHookProcedure) GetCommand() []string {
	if x != nil {
		return x.Command
	}
	return nil
...
func (x *BackingHookProcedure) GetTimeoutSeconds() uint32 {
	if x != nil {
...
func (x *BackingHookProcedure) GetBackingServiceId() string {
	if x != nil {
...
func (x *BackingHookProcedure) GetAttachId() string {
	if x != nil {
		return x.AttachId
	}
	return ""
...
func (x *BackingHookProcedure) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *BackingHookProcedure) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *BackingHookProcedure) GetEnvironmentId() string {
	if x != nil {
		return x.EnvironmentId
	}
	return ""
...
func (x *BackingHookProcedure) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *BackingHookProcedure) GetInputs() []*BackingHookValue {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *BackingHookProcedure) GetFacts() []*BackingHookValue {
	if x != nil {
		return x.Facts
	}
	return nil
...
func (x *BackingHookProcedure) GetFactSchema() []*BackingHookFactDefinition {
	if x != nil {
		return x.FactSchema
	}
	return nil
...
// STARTED authorizes the irreversible hook execution. RESULT conveys the
// complete validated result for Controller-side encryption and publication.
type BackingHookCheckpointRequest struct {
	state          protoimpl.MessageState     `protogen:"open.v1"`
	TaskId         string                     `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	OperationId    string                     `protobuf:"bytes,2,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty"`
	AssignmentId   string                     `protobuf:"bytes,3,opt,name=assignment_id,json=assignmentId,proto3" json:"assignment_id,omitempty"`
	...
	PlanHash       []byte                     `protobuf:"bytes,6,opt,name=plan_hash,json=planHash,proto3" json:"plan_hash,omitempty"`
	Event          BackingHookEvent           `protobuf:"varint,7,opt,name=event,proto3,enum=groundplane.agent.v1.BackingHookEvent" json:"event,omitempty"`
	State          BackingHookCheckpointState `protobuf:"varint,8,opt,name=state,proto3,enum=groundplane.agent.v1.BackingHookCheckpointState" json:"state,omitempty"`
	ResultSha256   []byte                     `protobuf:"bytes,9,opt,name=result_sha256,json=resultSha256,proto3" json:"result_sha256,omitempty"`
	Facts          []*BackingHookValue        `protobuf:"bytes,10,rep,name=facts,proto3" json:"facts,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *BackingHookCheckpointRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BackingHookCheckpointRequest) GetOperationId() string {
	if x != nil {
		return x.OperationId
	}
	return ""
...
func (x *BackingHookCheckpointRequest) GetAssignmentId() string {
	if x != nil {
		return x.AssignmentId
	}
	return ""
...
func (x *BackingHookCheckpointRequest) GetExecutionEpoch() uint32 {
	if x != nil {
		return x.ExecutionEpoch
	}
	return 0
...
func (x *BackingHookCheckpointRequest) GetStepId() string {
	if x != nil {
		return x.StepId
	}
	return ""
...
func (x *BackingHookCheckpointRequest) GetPlanHash() []byte {
	if x != nil {
		return x.PlanHash
	}
	return nil
...
func (x *BackingHookCheckpointRequest) GetEvent() BackingHookEvent {
	if x != nil {
		return x.Event
	}
	return BackingHookEvent_BACKING_HOOK_EVENT_UNSPECIFIED
...
func (x *BackingHookCheckpointRequest) GetState() BackingHookCheckpointState {
	if x != nil {
		return x.State
	}
	return BackingHookCheckpointState_BACKING_HOOK_CHECKPOINT_STATE_UNSPECIFIED
}

func (x *BackingHookCheckpointRequest) GetResultSha256() []byte {
	if x != nil {
...
func (x *BackingHookCheckpointRequest) GetFacts() []*BackingHookValue {
	if x != nil {
		return x.Facts
	}
	return nil
...
type BackingHookCheckpointAck struct {
	state          protoimpl.MessageState     `protogen:"open.v1"`
	TaskId         string                     `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	OperationId    string                     `protobuf:"bytes,2,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty"`
	AssignmentId   string                     `protobuf:"bytes,3,opt,name=assignment_id,json=assignmentId,proto3" json:"assignment_id,omitempty"`
	...
	State          BackingHookCheckpointState `protobuf:"varint,8,opt,name=state,proto3,enum=groundplane.agent.v1.BackingHookCheckpointState" json:"state,omitempty"`
	ResultSha256   []byte                     `protobuf:"bytes,9,opt,name=result_sha256,json=resultSha256,proto3" json:"result_sha256,omitempty"`
	Existing       bool                       `protobuf:"varint,10,opt,name=existing,proto3" json:"existing,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *BackingHookCheckpointAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BackingHookCheckpointAck) GetOperationId() string {
	if x != nil {
		return x.OperationId
	}
	return ""
...
func (x *BackingHookCheckpointAck) GetAssignmentId() string {
	if x != nil {
		return x.AssignmentId
	}
	return ""
...
func (x *BackingHookCheckpointAck) GetExecutionEpoch() uint32 {
	if x != nil {
		return x.ExecutionEpoch
	}
	return 0
...
func (x *BackingHookCheckpointAck) GetStepId() string {
	if x != nil {
		return x.StepId
	}
	return ""
...
func (x *BackingHookCheckpointAck) GetPlanHash() []byte {
	if x != nil {
		return x.PlanHash
	}
	return nil
...
func (x *BackingHookCheckpointAck) GetEvent() BackingHookEvent {
	if x != nil {
		return x.Event
	}
	return BackingHookEvent_BACKING_HOOK_EVENT_UNSPECIFIED
...
func (x *BackingHookCheckpointAck) GetState() BackingHookCheckpointState {
	if x != nil {
		return x.State
	}
	return BackingHookCheckpointState_BACKING_HOOK_CHECKPOINT_STATE_UNSPECIFIED
...
func (x *BackingHookCheckpointAck) GetResultSha256() []byte {
	if x != nil {
		return x.ResultSha256
	}
	return nil
...
func (x *BackingHookCheckpointAck) GetExisting() bool {
	if x != nil {
		return x.Existing
	}
	return false
...
type ExecutionPlan struct {
	...
	CandidateReleaseProcedure    *CandidateReleaseProcedure    `protobuf:"bytes,14,opt,name=candidate_release_procedure,json=candidateReleaseProcedure,proto3" json:"candidate_release_procedure,omitempty"`
...
func (x *ExecutionPlan) GetCandidateReleaseProcedure() *CandidateReleaseProcedure {
	if x != nil {
		return x.CandidateReleaseProcedure
	}
	return nil
}

func (x *ExecutionPlan) GetManagedComponentProcedure() *ManagedComponentProcedure {
	if x != nil {
		return x.ManagedComponentProcedure
	}
	return nil
}

func (x *ExecutionPlan) GetServiceLifecycleProcedure() *ServiceLifecycleProcedure {
	if x != nil {
		return x.ServiceLifecycleProcedure
	}
	return nil
}

func (x *ExecutionPlan) GetEntryMutationProcedure() *EntryMutationProcedure {
	if x != nil {
		return x.EntryMutationProcedure
	}
	return nil
}
...
type EntryMutationProcedure struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	BaselineArtifactId  string                 `protobuf:"bytes,1,opt,name=baseline_artifact_id,json=baselineArtifactId,proto3" json:"baseline_artifact_id,omitempty"`
	CandidateArtifactId string                 `protobuf:"bytes,2,opt,name=candidate_artifact_id,json=candidateArtifactId,proto3" json:"candidate_artifact_id,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *EntryMutationProcedure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EntryMutationProcedure) GetBaselineArtifactId() string {
	if x != nil {
		return x.BaselineArtifactId
	}
	return ""
}

func (x *EntryMutationProcedure) GetCandidateArtifactId() string {
	if x != nil {
		return x.CandidateArtifactId
	}
	return ""
...
type ServiceLifecycleProcedure struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Sources       []*ServiceLifecycleSource `protobuf:"bytes,1,rep,name=sources,proto3" json:"sources,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServiceLifecycleProcedure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ServiceLifecycleSource struct {
	state                  protoimpl.MessageState `protogen:"open.v1"`
	ArtifactId             string                 `protobuf:"bytes,1,opt,name=artifact_id,json=artifactId,proto3" json:"artifact_id,omitempty"`
	SourcePlanId           string                 `protobuf:"bytes,2,opt,name=source_plan_id,json=sourcePlanId,proto3" json:"source_plan_id,omitempty"`
	SourceRenderGeneration uint64                 `protobuf:"varint,3,opt,name=source_render_generation,json=sourceRenderGeneration,proto3" json:"source_render_generation,omitempty"`
	ServiceId              string                 `protobuf:"bytes,4,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	ComposeNames           []string               `protobuf:"bytes,5,rep,name=compose_names,json=composeNames,proto3" json:"compose_names,omitempty"`
...
func (x *ServiceLifecycleSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ServiceLifecycleSource) GetSourcePlanId() string {
	if x != nil {
...
func (x *ServiceLifecycleSource) GetSourceRenderGeneration() uint64 {
	if x != nil {
		return x.SourceRenderGeneration
	}
	return 0
}

func (x *ServiceLifecycleSource) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *ServiceLifecycleSource) GetComposeNames() []string {
	if x != nil {
		return x.ComposeNames
	}
	return nil
}

func (x *ServiceLifecycleSource) GetStepId() string {
	if x != nil {
		return x.StepId
	}
	return ""
...
type ManagedComponentProcedure struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	Services      []*ManagedComponentService `protobuf:"bytes,1,rep,name=services,proto3" json:"services,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ManagedComponentProcedure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ManagedComponentService struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	ComponentKind        string                 `protobuf:"bytes,1,opt,name=component_kind,json=componentKind,proto3" json:"component_kind,omitempty"`
	ComponentId          string                 `protobuf:"bytes,2,opt,name=component_id,json=componentId,proto3" json:"component_id,omitempty"`
	ServiceId            string                 `protobuf:"bytes,3,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	ComposeServiceName   string                 `protobuf:"bytes,4,opt,name=compose_service_name,json=composeServiceName,proto3" json:"compose_service_name,omitempty"`
	SourceRevisionId     string                 `protobuf:"bytes,5,opt,name=source_revision_id,json=sourceRevisionId,proto3" json:"source_revision_id,omitempty"`
	SourceArtifactId     string                 `protobuf:"bytes,6,opt,name=source_artifact_id,json=sourceArtifactId,proto3" json:"source_artifact_id,omitempty"`
	SourceArtifactSha256 []byte                 `protobuf:"bytes,7,opt,name=source_artifact_sha256,json=sourceArtifactSha256,proto3" json:"source_artifact_sha256,omitempty"`
	RemoveStepId         string                 `protobuf:"bytes,8,opt,name=remove_step_id,json=removeStepId,proto3" json:"remove_step_id,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ManagedComponentService) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ManagedComponentService) GetComponentId() string {
	if x != nil {
		return x.ComponentId
	}
	return ""
...
func (x *ManagedComponentService) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *ManagedComponentService) GetComposeServiceName() string {
	if x != nil {
		return x.ComposeServiceName
	}
	return ""
...
func (x *ManagedComponentService) GetSourceRevisionId() string {
	if x != nil {
...
func (x *ManagedComponentService) GetSourceArtifactId() string {
	if x != nil {
...
func (x *ManagedComponentService) GetSourceArtifactSha256() []byte {
	if x != nil {
		return x.SourceArtifactSha256
	}
	return nil
}

func (x *ManagedComponentService) GetRemoveStepId() string {
	if x != nil {
		return x.RemoveStepId
	}
	return ""
}
...
type CandidateReleaseProcedure struct {
	state                    protoimpl.MessageState    `protogen:"open.v1"`
	Members                  []*CandidateReleaseMember `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty"`
	ConfigurationRestoration *ConfigurationRestoration `protobuf:"bytes,2,opt,name=configuration_restoration,json=configurationRestoration,proto3" json:"configuration_restoration,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *CandidateReleaseProcedure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CandidateReleaseProcedure) GetConfigurationRestoration() *ConfigurationRestoration {
	if x != nil {
		return x.ConfigurationRestoration
	}
	return nil
}

// ConfigurationRestoration binds only destinations written by this Task.
// Empty prior snapshot identity records initial acknowledged absence, not
// permission to inspect desired state or discover restoration targets on-host.
type ConfigurationRestoration struct {
	state               protoimpl.MessageState          `protogen:"open.v1"`
	PriorSnapshotId     string                          `protobuf:"bytes,1,opt,name=prior_snapshot_id,json=priorSnapshotId,proto3" json:"prior_snapshot_id,omitempty"`
	PriorSnapshotSha256 []byte                          `protobuf:"bytes,2,opt,name=prior_snapshot_sha256,json=priorSnapshotSha256,proto3" json:"prior_snapshot_sha256,omitempty"`
	Files               []*ConfigurationFileRestoration `protobuf:"bytes,3,rep,name=files,proto3" json:"files,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ConfigurationRestoration) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ConfigurationRestoration) GetPriorSnapshotId() string {
	if x != nil {
		return x.PriorSnapshotId
	}
	return ""
}

func (x *ConfigurationRestoration) GetPriorSnapshotSha256() []byte {
	if x != nil {
		return x.PriorSnapshotSha256
	}
	return nil
}

func (x *ConfigurationRestoration) GetFiles() []*ConfigurationFileRestoration {
	if x != nil {
		return x.Files
	}
	return nil
...
type ConfigurationFileRestoration struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	ForwardStepId    string                 `protobuf:"bytes,1,opt,name=forward_step_id,json=forwardStepId,proto3" json:"forward_step_id,omitempty"`
	ProbeStepId      string                 `protobuf:"bytes,2,opt,name=probe_step_id,json=probeStepId,proto3" json:"probe_step_id,omitempty"`
	CompensateStepId string                 `protobuf:"bytes,3,opt,name=compensate_step_id,json=compensateStepId,proto3" json:"compensate_step_id,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ConfigurationFileRestoration) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ConfigurationFileRestoration) GetForwardStepId() string {
	if x != nil {
		return x.ForwardStepId
	}
	return ""
}

func (x *ConfigurationFileRestoration) GetProbeStepId() string {
	if x != nil {
		return x.ProbeStepId
	}
	return ""
}

func (x *ConfigurationFileRestoration) GetCompensateStepId() string {
	if x != nil {
		return x.CompensateStepId
	}
	return ""
}

type CandidateReleaseMember struct {
	state               protoimpl.MessageState         `protogen:"open.v1"`
	ServiceId           string                         `protobuf:"bytes,1,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	CandidateReleaseId  string                         `protobuf:"bytes,2,opt,name=candidate_release_id,json=candidateReleaseId,proto3" json:"candidate_release_id,omitempty"`
	CandidateArtifactId string                         `protobuf:"bytes,3,opt,name=candidate_artifact_id,json=candidateArtifactId,proto3" json:"candidate_artifact_id,omitempty"`
	ForwardStepIds      []string                       `protobuf:"bytes,4,rep,name=forward_step_ids,json=forwardStepIds,proto3" json:"forward_step_ids,omitempty"`
	ServingPredecessor  *ServingPredecessorRestoration `protobuf:"bytes,5,opt,name=serving_predecessor,json=servingPredecessor,proto3" json:"serving_predecessor,omitempty"`
	CandidateAbsence    *CandidateAbsenceRestoration   `protobuf:"bytes,6,opt,name=candidate_absence,json=candidateAbsence,proto3" json:"candidate_absence,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CandidateReleaseMember) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CandidateReleaseMember) GetCandidateReleaseId() string {
	if x != nil {
...
func (x *CandidateReleaseMember) GetCandidateArtifactId() string {
	if x != nil {
		return x.CandidateArtifactId
	}
	return ""
...
func (x *CandidateReleaseMember) GetForwardStepIds() []string {
	if x != nil {
		return x.ForwardStepIds
	}
	return nil
}

func (x *CandidateReleaseMember) GetServingPredecessor() *ServingPredecessorRestoration {
	if x != nil {
		return x.ServingPredecessor
	}
	return nil
}

func (x *CandidateReleaseMember) GetCandidateAbsence() *CandidateAbsenceRestoration {
	if x != nil {
		return x.CandidateAbsence
	}
	return nil
}

type ServingPredecessorRestoration struct {
	state                   protoimpl.MessageState `protogen:"open.v1"`
	ProbeStepId             string                 `protobuf:"bytes,1,opt,name=probe_step_id,json=probeStepId,proto3" json:"probe_step_id,omitempty"`
	CompensateStepId        string                 `protobuf:"bytes,2,opt,name=compensate_step_id,json=compensateStepId,proto3" json:"compensate_step_id,omitempty"`
	PriorArtifactId         string                 `protobuf:"bytes,3,opt,name=prior_artifact_id,json=priorArtifactId,proto3" json:"prior_artifact_id,omitempty"`
	...
	PriorTarget             string                 `protobuf:"bytes,5,opt,name=prior_target,json=priorTarget,proto3" json:"prior_target,omitempty"`
	RetainedPriorArtifactId string                 `protobuf:"bytes,6,opt,name=retained_prior_artifact_id,json=retainedPriorArtifactId,proto3" json:"retained_prior_artifact_id,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *ServingPredecessorRestoration) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ServingPredecessorRestoration) GetCompensateStepId() string {
	if x != nil {
		return x.CompensateStepId
	}
	return ""
...
func (x *ServingPredecessorRestoration) GetPriorArtifactId() string {
	if x != nil {
...
func (x *ServingPredecessorRestoration) GetPriorReleaseId() string {
	if x != nil {
...
func (x *ServingPredecessorRestoration) GetPriorTarget() string {
	if x != nil {
...
func (x *ServingPredecessorRestoration) GetRetainedPriorArtifactId() string {
	if x != nil {
		return x.RetainedPriorArtifactId
	}
	return ""
}

type CandidateAbsenceRestoration struct {
	state              protoimpl.MessageState     `protogen:"open.v1"`
	ComposeProjectName string                     `protobuf:"bytes,1,opt,name=compose_project_name,json=composeProjectName,proto3" json:"compose_project_name,omitempty"`
	Services           []*CandidateReleaseService `protobuf:"bytes,2,rep,name=services,proto3" json:"services,omitempty"`
	ProbeStepId        string                     `protobuf:"bytes,3,opt,name=probe_step_id,json=probeStepId,proto3" json:"probe_step_id,omitempty"`
	CompensateStepId   string                     `protobuf:"bytes,4,opt,name=compensate_step_id,json=compensateStepId,proto3" json:"compensate_step_id,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *CandidateAbsenceRestoration) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CandidateAbsenceRestoration) GetServices() []*CandidateReleaseService {
	if x != nil {
		return x.Services
	}
	return nil
...
func (x *CandidateAbsenceRestoration) GetProbeStepId() string {
	if x != nil {
		return x.ProbeStepId
	}
	return ""
...
func (x *CandidateAbsenceRestoration) GetCompensateStepId() string {
	if x != nil {
		return x.CompensateStepId
	}
	return ""
...
type CandidateReleaseService struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ServiceId     string                 `protobuf:"bytes,1,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	ReleaseId     string                 `protobuf:"bytes,2,opt,name=release_id,json=releaseId,proto3" json:"release_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *CandidateReleaseService) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CandidateReleaseService) GetReleaseId() string {
	if x != nil {
		return x.ReleaseId
	}
	return ""
...
type CandidateRestorationProbe struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CandidateRestorationProbe) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CandidateRestorationProbe) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *CandidateRestorationProbe) GetCandidateReleaseId() string {
	if x != nil {
		return x.CandidateReleaseId
	}
	return ""
...
type CandidateRestorationCompensate struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	CandidateArtifactId string                 `protobuf:"bytes,1,opt,name=candidate_artifact_id,json=candidateArtifactId,proto3" json:"candidate_artifact_id,omitempty"`
	ServiceId           string                 `protobuf:"bytes,2,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	CandidateReleaseId  string                 `protobuf:"bytes,3,opt,name=candidate_release_id,json=candidateReleaseId,proto3" json:"candidate_release_id,omitempty"`
...
func (x *CandidateRestorationCompensate) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CandidateRestorationCompensate) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *CandidateRestorationCompensate) GetCandidateReleaseId() string {
	if x != nil {
		return x.CandidateReleaseId
	}
	return ""
...
type ExecutionStep struct {
	...
	//	*ExecutionStep_CandidateRestorationProbe
	//	*ExecutionStep_CandidateRestorationCompensate
...
func (x *ExecutionStep) GetCandidateRestorationProbe() *CandidateRestorationProbe {
	if x != nil {
		if x, ok := x.Payload.(*ExecutionStep_CandidateRestorationProbe); ok {
			return x.CandidateRestorationProbe
		}
	}
	return nil
}

func (x *ExecutionStep) GetCandidateRestorationCompensate() *CandidateRestorationCompensate {
	if x != nil {
		if x, ok := x.Payload.(*ExecutionStep_CandidateRestorationCompensate); ok {
			return x.CandidateRestorationCompensate
		}
	}
	return nil
}

func (x *ExecutionStep) GetManagedNetworkEnsure() *ManagedNetworkEnsure {
	if x != nil {
		if x, ok := x.Payload.(*ExecutionStep_ManagedNetworkEnsure); ok {
			return x.ManagedNetworkEnsure
		}
	}
	return nil
}

func (x *ExecutionStep) GetManagedVolumeEnsure() *ManagedVolumeEnsure {
	if x != nil {
		if x, ok := x.Payload.(*ExecutionStep_ManagedVolumeEnsure); ok {
			return x.ManagedVolumeEnsure
		}
	}
	return nil
}

func (x *ExecutionStep) GetBackingHookProcedure() *BackingHookProcedure {
	if x != nil {
		if x, ok := x.Payload.(*ExecutionStep_BackingHookProcedure); ok {
			return x.BackingHookProcedure
		}
	}
	return nil
}
...
type ExecutionStep_CandidateRestorationProbe struct {
	CandidateRestorationProbe *CandidateRestorationProbe `protobuf:"bytes,32,opt,name=candidate_restoration_probe,json=candidateRestorationProbe,proto3,oneof"`
}

type ExecutionStep_CandidateRestorationCompensate struct {
	CandidateRestorationCompensate *CandidateRestorationCompensate `protobuf:"bytes,33,opt,name=candidate_restoration_compensate,json=candidateRestorationCompensate,proto3,oneof"`
}

type ExecutionStep_ManagedNetworkEnsure struct {
	ManagedNetworkEnsure *ManagedNetworkEnsure `protobuf:"bytes,34,opt,name=managed_network_ensure,json=managedNetworkEnsure,proto3,oneof"`
}

type ExecutionStep_ManagedVolumeEnsure struct {
	ManagedVolumeEnsure *ManagedVolumeEnsure `protobuf:"bytes,35,opt,name=managed_volume_ensure,json=managedVolumeEnsure,proto3,oneof"`
}

type ExecutionStep_BackingHookProcedure struct {
...
func (*ExecutionStep_CandidateRestorationProbe) isExecutionStep_Payload() {}

func (*ExecutionStep_CandidateRestorationCompensate) isExecutionStep_Payload() {}

func (*ExecutionStep_ManagedNetworkEnsure) isExecutionStep_Payload() {}

func (*ExecutionStep_ManagedVolumeEnsure) isExecutionStep_Payload() {}
...
func (x *ManagedNetworkEnsure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ManagedNetworkEnsure) GetNetworkId() string {
	if x != nil {
		return x.NetworkId
	}
	return ""
...
func (x *ManagedVolumeEnsure) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ManagedVolumeEnsure) GetVolumeId() string {
	if x != nil {
		return x.VolumeId
	}
	return ""
...
type ResolvedRunnerSnapshot struct {
	...
	LocalImageId                       string                            `protobuf:"bytes,14,opt,name=local_image_id,json=localImageId,proto3" json:"local_image_id,omitempty"`
	...
	ServiceSource                      *ScriptSourceAuthority            `protobuf:"bytes,27,opt,name=service_source,json=serviceSource,proto3" json:"service_source,omitempty"`
	NetworkTopologySource              *ScriptSourceAuthority            `protobuf:"bytes,28,opt,name=network_topology_source,json=networkTopologySource,proto3" json:"network_topology_source,omitempty"`
	AppliedEnvironmentSource           *ScriptSourceAuthority            `protobuf:"bytes,29,opt,name=applied_environment_source,json=appliedEnvironmentSource,proto3" json:"applied_environment_source,omitempty"`
	ExplicitExecution                  *ScriptExplicitExecutionAuthority `protobuf:"bytes,30,opt,name=explicit_execution,json=explicitExecution,proto3" json:"explicit_execution,omitempty"`
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
}
...
func (x *ResolvedRunnerSnapshot) GetLocalImageId() string {
	if x != nil {
		return x.LocalImageId
	}
	return ""
...
func (x *ResolvedRunnerSnapshot) GetServiceSource() *ScriptSourceAuthority {
	if x != nil {
...
func (x *ResolvedRunnerSnapshot) GetNetworkTopologySource() *ScriptSourceAuthority {
	if x != nil {
		return x.NetworkTopologySource
	}
	return nil
}

func (x *ResolvedRunnerSnapshot) GetAppliedEnvironmentSource() *ScriptSourceAuthority {
	if x != nil {
		return x.AppliedEnvironmentSource
	}
	return nil
}

func (x *ResolvedRunnerSnapshot) GetExplicitExecution() *ScriptExplicitExecutionAuthority {
	if x != nil {
		return x.ExplicitExecution
	}
	return nil
}
...
type ScriptExplicitExecutionAuthority struct {
	state               protoimpl.MessageState          `protogen:"open.v1"`
	Context             *ScriptExplicitExecutionContext `protobuf:"bytes,1,opt,name=context,proto3" json:"context,omitempty"`
	ContextSha256       []byte                          `protobuf:"bytes,2,opt,name=context_sha256,json=contextSha256,proto3" json:"context_sha256,omitempty"`
	ScriptModRevision   uint64                          `protobuf:"varint,3,opt,name=script_mod_revision,json=scriptModRevision,proto3" json:"script_mod_revision,omitempty"`
	ReleaseLocalImageId string                          `protobuf:"bytes,4,opt,name=release_local_image_id,json=releaseLocalImageId,proto3" json:"release_local_image_id,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ScriptExplicitExecutionAuthority) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScriptExplicitExecutionAuthority) GetContextSha256() []byte {
	if x != nil {
...
func (x *ScriptExplicitExecutionAuthority) GetScriptModRevision() uint64 {
	if x != nil {
		return x.ScriptModRevision
	}
	return 0
}

func (x *ScriptExplicitExecutionAuthority) GetReleaseLocalImageId() string {
	if x != nil {
		return x.ReleaseLocalImageId
	}
	return ""
}
...
type ScriptExplicitExecutionContext struct {
	state          protoimpl.MessageState       `protogen:"open.v1"`
	...
	Volumes        []*ScriptExplicitVolumeGrant `protobuf:"bytes,3,rep,name=volumes,proto3" json:"volumes,omitempty"`
...
func (x *ScriptExplicitExecutionContext) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScriptExplicitExecutionContext) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *ScriptExplicitExecutionContext) GetVolumes() []*ScriptExplicitVolumeGrant {
	if x != nil {
		return x.Volumes
	}
	return nil
...
func (x *ScriptExplicitExecutionContext) GetEntryIds() []string {
	if x != nil {
		return x.EntryIds
	}
	return nil
...
type ScriptExplicitVolumeGrant struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VolumeId      string                 `protobuf:"bytes,1,opt,name=volume_id,json=volumeId,proto3" json:"volume_id,omitempty"`
...
func (x *ScriptExplicitVolumeGrant) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScriptExplicitVolumeGrant) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *ScriptExplicitVolumeGrant) GetReadOnly() bool {
	if x != nil {
		return x.ReadOnly
	}
	return false
...
type ScriptRunnerNetwork struct {
	...
	Source             *ScriptSourceAuthority   `protobuf:"bytes,4,opt,name=source,proto3" json:"source,omitempty"`
	OwnerEnvironmentId string                   `protobuf:"bytes,5,opt,name=owner_environment_id,json=ownerEnvironmentId,proto3" json:"owner_environment_id,omitempty"` // actual Zone owner, including backing-owned Attach Networks
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ScriptRunnerNetwork) GetSource() *ScriptSourceAuthority {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *ScriptRunnerNetwork) GetOwnerEnvironmentId() string {
	if x != nil {
		return x.OwnerEnvironmentId
	}
	return ""
}
...
func (x *ScriptRunnerMount) GetSource() *ScriptSourceAuthority {
	if x != nil {
		return x.Source
	}
	return nil
...
type ScriptSourceAuthority struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	Existing      *ScriptExistingSourceAuthority `protobuf:"bytes,1,opt,name=existing,proto3" json:"existing,omitempty"`
	Staged        *ScriptStagedSourceAuthority   `protobuf:"bytes,2,opt,name=staged,proto3" json:"staged,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ScriptSourceAuthority) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScriptSourceAuthority) GetStaged() *ScriptStagedSourceAuthority {
	if x != nil {
		return x.Staged
	}
	return nil
...
type ScriptExistingSourceAuthority struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ModRevision   uint64                 `protobuf:"varint,1,opt,name=mod_revision,json=modRevision,proto3" json:"mod_revision,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ScriptExistingSourceAuthority) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ScriptStagedSourceAuthority struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	EnvironmentId        string                 `protobuf:"bytes,1,opt,name=environment_id,json=environmentId,proto3" json:"environment_id,omitempty"`
	RevisionId           string                 `protobuf:"bytes,2,opt,name=revision_id,json=revisionId,proto3" json:"revision_id,omitempty"`
	RenderGeneration     uint64                 `protobuf:"varint,3,opt,name=render_generation,json=renderGeneration,proto3" json:"render_generation,omitempty"`
	FixedReadRevision    uint64                 `protobuf:"varint,4,opt,name=fixed_read_revision,json=fixedReadRevision,proto3" json:"fixed_read_revision,omitempty"`
	CanonicalValueSha256 []byte                 `protobuf:"bytes,5,opt,name=canonical_value_sha256,json=canonicalValueSha256,proto3" json:"canonical_value_sha256,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ScriptStagedSourceAuthority) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScriptStagedSourceAuthority) GetRevisionId() string {
	if x != nil {
		return x.RevisionId
	}
	return ""
...
func (x *ScriptStagedSourceAuthority) GetRenderGeneration() uint64 {
	if x != nil {
		return x.RenderGeneration
	}
	return 0
...
func (x *ScriptStagedSourceAuthority) GetFixedReadRevision() uint64 {
	if x != nil {
		return x.FixedReadRevision
	}
	return 0
}

func (x *ScriptStagedSourceAuthority) GetCanonicalValueSha256() []byte {
	if x != nil {
		return x.CanonicalValueSha256
	}
	return nil
}
...
type AdapterProcedure struct {
	...
	Authentication   BackingAuthentication  `protobuf:"varint,9,opt,name=authentication,proto3,enum=groundplane.agent.v1.BackingAuthentication" json:"authentication,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AdapterProcedure) GetAuthentication() BackingAuthentication {
	if x != nil {
		return x.Authentication
	}
	return BackingAuthentication_BACKING_AUTHENTICATION_UNSPECIFIED
}
...
type VolumeRemovalCheckpointRequest struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	RequestId         string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	TaskId            string                 `protobuf:"bytes,2,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	OperationId       string                 `protobuf:"bytes,3,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty"`
	...
	StepId            string                 `protobuf:"bytes,5,opt,name=step_id,json=stepId,proto3" json:"step_id,omitempty"`
	PlanHash          []byte                 `protobuf:"bytes,6,opt,name=plan_hash,json=planHash,proto3" json:"plan_hash,omitempty"`
	ConsumersDetached bool                   `protobuf:"varint,7,opt,name=consumers_detached,json=consumersDetached,proto3" json:"consumers_detached,omitempty"` // request first/pending call after mount absence proof
	Completion        []byte                 `protobuf:"bytes,8,opt,name=completion,proto3" json:"completion,omitempty"`                                         // alternatively acknowledge the exact helper result
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *VolumeRemovalCheckpointRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *VolumeRemovalCheckpointRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *VolumeRemovalCheckpointRequest) GetOperationId() string {
	if x != nil {
		return x.OperationId
	}
	return ""
...
func (x *VolumeRemovalCheckpointRequest) GetAssignmentId() string {
	if x != nil {
		return x.AssignmentId
	}
	return ""
...
func (x *VolumeRemovalCheckpointRequest) GetStepId() string {
	if x != nil {
		return x.StepId
	}
	return ""
...
func (x *VolumeRemovalCheckpointRequest) GetPlanHash() []byte {
	if x != nil {
		return x.PlanHash
	}
	return nil
...
func (x *VolumeRemovalCheckpointRequest) GetConsumersDetached() bool {
	if x != nil {
		return x.ConsumersDetached
	}
	return false
}

func (x *VolumeRemovalCheckpointRequest) GetCompletion() []byte {
	if x != nil {
		return x.Completion
	}
	return nil
...
type VolumeRemovalCheckpointAck struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	RequestId       string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	TaskId          string                 `protobuf:"bytes,2,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	OperationId     string                 `protobuf:"bytes,3,opt,name=operation_id,json=operationId,proto3" json:"operation_id,omitempty"`
	AssignmentId    string                 `protobuf:"bytes,4,opt,name=assignment_id,json=assignmentId,proto3" json:"assignment_id,omitempty"`
	PendingPath     []byte                 `protobuf:"bytes,5,opt,name=pending_path,json=pendingPath,proto3" json:"pending_path,omitempty"`              // already durable before the helper may run
	DirectoryAbsent bool                   `protobuf:"varint,6,opt,name=directory_absent,json=directoryAbsent,proto3" json:"directory_absent,omitempty"` // exclusive with pending_path
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *VolumeRemovalCheckpointAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *VolumeRemovalCheckpointAck) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *VolumeRemovalCheckpointAck) GetOperationId() string {
	if x != nil {
		return x.OperationId
	}
	return ""
...
func (x *VolumeRemovalCheckpointAck) GetAssignmentId() string {
	if x != nil {
		return x.AssignmentId
	}
	return ""
...
func (x *VolumeRemovalCheckpointAck) GetPendingPath() []byte {
	if x != nil {
		return x.PendingPath
	}
	return nil
}

func (x *VolumeRemovalCheckpointAck) GetDirectoryAbsent() bool {
	if x != nil {
		return x.DirectoryAbsent
	}
	return false
}
...
type EnvironmentDirectoryHelperRequest struct {
	...
	AssignmentId             string                 `protobuf:"bytes,7,opt,name=assignment_id,json=assignmentId,proto3" json:"assignment_id,omitempty"`
	VolumeRemovalPendingPath []byte                 `protobuf:"bytes,8,opt,name=volume_removal_pending_path,json=volumeRemovalPendingPath,proto3" json:"volume_removal_pending_path,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *EnvironmentDirectoryHelperRequest) GetVolumeRemovalPendingPath() []byte {
	if x != nil {
		return x.VolumeRemovalPendingPath
	}
	return nil
}
...
type EnvironmentDirectoryHelperResponse struct {
	...
	VolumeRemovalCompletion []byte                 `protobuf:"bytes,8,opt,name=volume_removal_completion,json=volumeRemovalCompletion,proto3" json:"volume_removal_completion,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *EnvironmentDirectoryHelperResponse) GetVolumeRemovalCompletion() []byte {
	if x != nil {
		return x.VolumeRemovalCompletion
	}
	return nil
}
...
func (x *ComposeHelperRequest) GetRestorationAuthority() *ReleaseRestorationAuthority {
	if x != nil {
		return x.RestorationAuthority
	}
	return nil
...
type ComposeHelperResponse struct {
	...
	CandidateAbsenceEvidence *CandidateAbsenceEvidence `protobuf:"bytes,7,opt,name=candidate_absence_evidence,json=candidateAbsenceEvidence,proto3" json:"candidate_absence_evidence,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ComposeHelperResponse) GetCandidateAbsenceEvidence() *CandidateAbsenceEvidence {
	if x != nil {
		return x.CandidateAbsenceEvidence
	}
	return nil
...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\n" +
	"\bselector\"\x81\x01\n" +
	"\x15ResolveWorkloadImages\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12I\n" +
	"\tselectors\x18\x02 \x03(\v2+.groundplane.agent.v1.WorkloadImageSelectorR\tselectors\"\x88\x01\n" +
	"\x17WorkloadImageResolution\x12G\n" +
	"\bselector\x18\x01 \x01(\v2+.groundplane.agent.v1.WorkloadImageSelectorR\bselector\x12$\n" +
	"\x0elocal_image_id\x18\x02 \x01(\tR\flocalImageId\"k\n" +
	"\x18WorkloadImageResolutions\x12O\n" +
	"\vresolutions\x18\x01 \x03(\v2-.groundplane.agent.v1.WorkloadImageResolutionR\vresolutions\"\xb3\x01\n" +
	"\x1eWorkloadImageResolutionFailure\x12.\n" +
	"\x10selector_ordinal\x18\x01 \x01(\rH\x00R\x0fselectorOrdinal\x88\x01\x01\x12L\n" +
	"\x04kind\x18\x02 \x01(\x0e28.groundplane.agent.v1.WorkloadImageResolutionFailureKindR\x04kindB\x13\n" +
	"\x11_selector_ordinal\"\xe7\x01\n" +
	"\x1dWorkloadImageResolutionResult\x12\x1d\n" +
	"\n" +
	...
	"\atargets\x18\x02 \x03(\v2..groundplane.agent.v1.ServiceObservationTargetR\atargets\"9\n" +
	"\x18CancelServiceObservation\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\"\xda\x01\n" +
	"\x14ServiceReplicaCounts\x12\x18\n" +
	"\arunning\x18\x01 \x01(\rR\arunning\x12\x18\n" +
	"\ahealthy\x18\x02 \x01(\rR\ahealthy\x12\x1a\n" +
	"\bstarting\x18\x03 \x01(\rR\bstarting\x12\x1c\n" +
	...
	"\fobservations\x18\x02 \x03(\v2+.groundplane.agent.v1.ServiceObservationRowR\fobservations\"\x8f\x02\n" +
	"\tTaskEvent\x12\x17\n" +
	...
	"\rassignment_id\x18\b \x01(\tR\fassignmentId\"\xfc\x01\n" +
	"\fTaskEventAck\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x1b\n" +
	"\tplan_hash\x18\x02 \x01(\fR\bplanHash\x12\x17\n" +
	"\astep_id\x18\x03 \x01(\tR\x06stepId\x12'\n" +
	"\x0fexecution_epoch\x18\x04 \x01(\rR\x0eexecutionEpoch\x12\x18\n" +
	...
	"\x06labels\x18\x03 \x03(\v2\x1f.groundplane.agent.v1.LabelPairR\x06labels\"\xdc\x01\n" +
	...
	"!dns_resolver_rollback_observation\x18\b \x01(\v24.groundplane.agent.v1.DNSResolverObservationEvidenceR\x1ednsResolverRollbackObservation\x12l\n" +
	"\x1acandidate_absence_evidence\x18\t \x01(\v2..groundplane.agent.v1.CandidateAbsenceEvidenceR\x18candidateAbsenceEvidence\"\xe3\x02\n" +
	"\x18CandidateAbsenceEvidence\x12#\n" +
	"\rassignment_id\x18\x01 \x01(\tR\fassignmentId\x12\x1b\n" +
	"\tplan_hash\x18\x02 \x01(\fR\bplanHash\x12)\n" +
	"\x10authority_sha256\x18\x03 \x01(\fR\x0fauthoritySha256\x120\n" +
	"\x14compose_project_name\x18\x04 \x01(\tR\x12composeProjectName\x122\n" +
	"\x15candidate_artifact_id\x18\x05 \x01(\tR\x13candidateArtifactId\x12M\n" +
	"\n" +
	...
	"\x0fresponse_sha256\x18\x05 \x01(\fR\x0eresponseSha256\"\xb2\f\n" +
	...
	"\x15script_checkpoint_ack\x18\v \x01(\v2).groundplane.agent.v1.ScriptCheckpointAckH\x00R\x13scriptCheckpointAck\x12e\n" +
	"\x17resolve_workload_images\x18\f \x01(\v2+.groundplane.agent.v1.ResolveWorkloadImagesH\x00R\x15resolveWorkloadImages\x12u\n" +
	"\x1dvolume_removal_checkpoint_ack\x18\r \x01(\v20.groundplane.agent.v1.VolumeRemovalCheckpointAckH\x00R\x1avolumeRemovalCheckpointAck\x12R\n" +
	"\x10observe_services\x18\x0e \x01(\v2%.groundplane.agent.v1.ObserveServicesH\x00R\x0fobserveServices\x12n\n" +
	"\x1acancel_service_observation\x18\x0f \x01(\v2..groundplane.agent.v1.CancelServiceObservationH\x00R\x18cancelServiceObservation\x12o\n" +
	"\x1bbacking_hook_checkpoint_ack\x18\x10 \x01(\v2..groundplane.agent.v1.BackingHookCheckpointAckH\x00R\x18backingHookCheckpointAck\x12J\n" +
	...
	"\x04plan\x18\x04 \x01(\v2#.groundplane.agent.v1.ExecutionPlanR\x04plan\x12E\n" +
	"\x10forward_deadline\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0fforwardDeadline\x12#\n" +
	...
	"\x15restoration_authority\x18\x13 \x01(\v21.groundplane.agent.v1.ReleaseRestorationAuthorityR\x14restorationAuthority\x12C\n" +
	"\x1erelease_recovery_record_sha256\x18\x14 \x01(\fR\x1breleaseRecoveryRecordSha256\x12l\n" +
	"\x1arelease_recovery_directive\x18\x15 \x01(\v2..groundplane.agent.v1.ReleaseRecoveryDirectiveR\x18releaseRecoveryDirective\x12I\n" +
	"\x12execution_deadline\x18\x16 \x01(\v2\x1a.google.protobuf.TimestampR\x11executionDeadlineJ\x04\b\x05\x10\x06\"\x9d\x02\n" +
	"\x18ReleaseRecoveryDirective\x12\x19\n" +
	"\bstep_ids\x18\x01 \x03(\tR\astepIds\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\rR\x06cursor\x12C\n" +
	"\x1erelease_recovery_record_sha256\x18\x03 \x01(\fR\x1breleaseRecoveryRecordSha256\x12@\n" +
	"\x05phase\x18\x04 \x01(\x0e2*.groundplane.agent.v1.ReleaseRecoveryPhaseR\x05phase\x12G\n" +
	" applicable_compensation_step_ids\x18\x05 \x03(\tR\x1dapplicableCompensationStepIds\"\xa3\x01\n" +
	"\x1bReleaseRestorationCandidate\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\x12\x1d\n" +
	"\n" +
	"release_id\x18\x02 \x01(\tR\treleaseId\x12F\n" +
	"\x06target\x18\x03 \x01(\x0e2..groundplane.agent.v1.ReleaseRestorationTargetR\x06target\"\xf8\x01\n" +
	"\"ReleaseAppliedPredecessorAuthority\x12!\n" +
	"\fkey_revision\x18\x01 \x01(\x03R\vkeyRevision\x12\x1f\n" +
	"\vrevision_id\x18\x02 \x01(\tR\n" +
	"revisionId\x12+\n" +
	"\x11render_generation\x18\x03 \x01(\x04R\x10renderGeneration\x126\n" +
	"\x17compose_artifact_sha256\x18\x04 \x01(\fR\x15composeArtifactSha256\x12)\n" +
	"\x10compose_artifact\x18\x05 \x01(\fR\x0fcomposeArtifact\"\xaa\x04\n" +
	"\x1bReleaseRestorationAuthority\x12\x17\n" +
	"\atask_id\x18\x02 \x01(\tR\x06taskId\x12!\n" +
	"\foperation_id\x18\x03 \x01(\tR\voperationId\x12\x1b\n" +
	"\tplan_hash\x18\x04 \x01(\fR\bplanHash\x12%\n" +
	"\x0eenvironment_id\x18\x05 \x01(\tR\renvironmentId\x122\n" +
	"\x15candidate_artifact_id\x18\x06 \x01(\tR\x13candidateArtifactId\x12Q\n" +
	"\n" +
	"candidates\x18\a \x03(\v21.groundplane.agent.v1.ReleaseRestorationCandidateR\n" +
	"candidates\x12i\n" +
	"\x13applied_predecessor\x18\b \x01(\v28.groundplane.agent.v1.ReleaseAppliedPredecessorAuthorityR\x12appliedPredecessor\x12)\n" +
	"\x10authority_sha256\x18\t \x01(\fR\x0fauthoritySha256\x12h\n" +
	"\x13native_predecessors\x18\n" +
	" \x03(\v27.groundplane.agent.v1.ReleaseNativePredecessorAuthorityR\x12nativePredecessorsJ\x04\b\x01\x10\x02\"\xa5\x01\n" +
	"!ReleaseNativePredecessorAuthority\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\x12)\n" +
	"\x10current_artifact\x18\x02 \x01(\fR\x0fcurrentArtifact\x126\n" +
	"\x17retained_prior_artifact\x18\x03 \x01(\fR\x15retainedPriorArtifact\"!\n" +
	...
	"\x16control_payload_sha256\x18\a \x01(\fR\x14controlPayloadSha256\":\n" +
	"\x10BackingHookValue\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\"E\n" +
	"\x19BackingHookFactDefinition\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x16\n" +
	"\x06secret\x18\x02 \x01(\bR\x06secret\"\xb4\x04\n" +
	"\x14BackingHookProcedure\x12<\n" +
	"\x05event\x18\x01 \x01(\x0e2&.groundplane.agent.v1.BackingHookEventR\x05event\x12\x18\n" +
	"\acommand\x18\x02 \x03(\tR\acommand\x12'\n" +
	"\x0ftimeout_seconds\x18\x03 \x01(\rR\x0etimeoutSeconds\x12,\n" +
	"\x12backing_service_id\x18\x04 \x01(\tR\x10backingServiceId\x12\x1b\n" +
	"\tattach_id\x18\x05 \x01(\tR\battachId\x12\x1b\n" +
	...
	"\x06inputs\x18\n" +
	" \x03(\v2&.groundplane.agent.v1.BackingHookValueR\x06inputs\x12<\n" +
	"\x05facts\x18\v \x03(\v2&.groundplane.agent.v1.BackingHookValueR\x05facts\x12P\n" +
	"\vfact_schema\x18\f \x03(\v2/.groundplane.agent.v1.BackingHookFactDefinitionR\n" +
	"factSchema\"\xc7\x03\n" +
	"\x1cBackingHookCheckpointRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12!\n" +
	"\foperation_id\x18\x02 \x01(\tR\voperationId\x12#\n" +
	"\rassignment_id\x18\x03 \x01(\tR\fassignmentId\x12'\n" +
	"\x0fexecution_epoch\x18\x04 \x01(\rR\x0eexecutionEpoch\x12\x17\n" +
	"\astep_id\x18\x05 \x01(\tR\x06stepId\x12\x1b\n" +
	"\tplan_hash\x18\x06 \x01(\fR\bplanHash\x12<\n" +
	"\x05event\x18\a \x01(\x0e2&.groundplane.agent.v1.BackingHookEventR\x05event\x12F\n" +
	"\x05state\x18\b \x01(\x0e20.groundplane.agent.v1.BackingHookCheckpointStateR\x05state\x12#\n" +
	"\rresult_sha256\x18\t \x01(\fR\fresultSha256\x12<\n" +
	"\x05facts\x18\n" +
	" \x03(\v2&.groundplane.agent.v1.BackingHookValueR\x05facts\"\xa1\x03\n" +
	"\x18BackingHookCheckpointAck\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12!\n" +
	"\foperation_id\x18\x02 \x01(\tR\voperationId\x12#\n" +
	"\rassignment_id\x18\x03 \x01(\tR\fassignmentId\x12'\n" +
	"\x0fexecution_epoch\x18\x04 \x01(\rR\x0eexecutionEpoch\x12\x17\n" +
	...
	"\x1ecomponent_rollback_observation\x18\r \x01(\v2$.groundplane.agent.v1.ComponentApplyR\x1ccomponentRollbackObservation\x12o\n" +
	...
	"\x19ServiceLifecycleProcedure\x12F\n" +
	"\asources\x18\x01 \x03(\v2,.groundplane.agent.v1.ServiceLifecycleSourceR\asources\"\xf6\x01\n" +
	"\x16ServiceLifecycleSource\x12\x1f\n" +
	"\vartifact_id\x18\x01 \x01(\tR\n" +
	"artifactId\x12$\n" +
	"\x0esource_plan_id\x18\x02 \x01(\tR\fsourcePlanId\x128\n" +
	"\x18source_render_generation\x18\x03 \x01(\x04R\x16sourceRenderGeneration\x12\x1d\n" +
	"\n" +
	"service_id\x18\x04 \x01(\tR\tserviceId\x12#\n" +
	"\rcompose_names\x18\x05 \x03(\tR\fcomposeNames\x12\x17\n" +
	"\astep_id\x18\x06 \x01(\tR\x06stepId\"f\n" +
	"\x19ManagedComponentProcedure\x12I\n" +
	"\bservices\x18\x01 \x03(\v2-.groundplane.agent.v1.ManagedComponentServiceR\bservices\"\xec\x02\n" +
	"\x17ManagedComponentService\x12%\n" +
	"\x0ecomponent_kind\x18\x01 \x01(\tR\rcomponentKind\x12!\n" +
	"\fcomponent_id\x18\x02 \x01(\tR\vcomponentId\x12\x1d\n" +
	"\n" +
	"service_id\x18\x03 \x01(\tR\tserviceId\x120\n" +
	"\x14compose_service_name\x18\x04 \x01(\tR\x12composeServiceName\x12,\n" +
	"\x12source_revision_id\x18\x05 \x01(\tR\x10sourceRevisionId\x12,\n" +
	"\x12source_artifact_id\x18\x06 \x01(\tR\x10sourceArtifactId\x124\n" +
	"\x16source_artifact_sha256\x18\a \x01(\fR\x14sourceArtifactSha256\x12$\n" +
	"\x0eremove_step_id\x18\b \x01(\tR\fremoveStepId\"\xd0\x01\n" +
	"\x19CandidateReleaseProcedure\x12F\n" +
	"\amembers\x18\x01 \x03(\v2,.groundplane.agent.v1.CandidateReleaseMemberR\amembers\x12k\n" +
	"\x19configuration_restoration\x18\x02 \x01(\v2..groundplane.agent.v1.ConfigurationRestorationR\x18configurationRestoration\"\xc4\x01\n" +
	"\x18ConfigurationRestoration\x12*\n" +
	"\x11prior_snapshot_id\x18\x01 \x01(\tR\x0fpriorSnapshotId\x122\n" +
	"\x15prior_snapshot_sha256\x18\x02 \x01(\fR\x13priorSnapshotSha256\x12H\n" +
	"\x05files\x18\x03 \x03(\v22.groundplane.agent.v1.ConfigurationFileRestorationR\x05files\"\x98\x01\n" +
	"\x1cConfigurationFileRestoration\x12&\n" +
	"\x0fforward_step_id\x18\x01 \x01(\tR\rforwardStepId\x12\"\n" +
	"\rprobe_step_id\x18\x02 \x01(\tR\vprobeStepId\x12,\n" +
	"\x12compensate_step_id\x18\x03 \x01(\tR\x10compensateStepId\"\x8d\x03\n" +
	"\x16CandidateReleaseMember\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\x120\n" +
	"\x14candidate_release_id\x18\x02 \x01(\tR\x12candidateReleaseId\x122\n" +
	"\x15candidate_artifact_id\x18\x03 \x01(\tR\x13candidateArtifactId\x12(\n" +
	"\x10forward_step_ids\x18\x04 \x03(\tR\x0eforwardStepIds\x12d\n" +
	"\x13serving_predecessor\x18\x05 \x01(\v23.groundplane.agent.v1.ServingPredecessorRestorationR\x12servingPredecessor\x12^\n" +
	"\x11candidate_absence\x18\x06 \x01(\v21.groundplane.agent.v1.CandidateAbsenceRestorationR\x10candidateAbsence\"\xa7\x02\n" +
	"\x1dServingPredecessorRestoration\x12\"\n" +
	"\rprobe_step_id\x18\x01 \x01(\tR\vprobeStepId\x12,\n" +
	"\x12compensate_step_id\x18\x02 \x01(\tR\x10compensateStepId\x12*\n" +
	"\x11prior_artifact_id\x18\x03 \x01(\tR\x0fpriorArtifactId\x12(\n" +
	"\x10prior_release_id\x18\x04 \x01(\tR\x0epriorReleaseId\x12!\n" +
	"\fprior_target\x18\x05 \x01(\tR\vpriorTarget\x12;\n" +
	"\x1aretained_prior_artifact_id\x18\x06 \x01(\tR\x17retainedPriorArtifactId\"\xec\x01\n" +
	"\x1bCandidateAbsenceRestoration\x120\n" +
	"\x14compose_project_name\x18\x01 \x01(\tR\x12composeProjectName\x12I\n" +
	"\bservices\x18\x02 \x03(\v2-.groundplane.agent.v1.CandidateReleaseServiceR\bservices\x12\"\n" +
	"\rprobe_step_id\x18\x03 \x01(\tR\vprobeStepId\x12,\n" +
	"\x12compensate_step_id\x18\x04 \x01(\tR\x10compensateStepId\"W\n" +
	"\x17CandidateReleaseService\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\x12\x1d\n" +
	"\n" +
	"release_id\x18\x02 \x01(\tR\treleaseId\"\xa0\x01\n" +
	"\x19CandidateRestorationProbe\x122\n" +
	"\x15candidate_artifact_id\x18\x01 \x01(\tR\x13candidateArtifactId\x12\x1d\n" +
	"\n" +
	"service_id\x18\x02 \x01(\tR\tserviceId\x120\n" +
	"\x14candidate_release_id\x18\x03 \x01(\tR\x12candidateReleaseId\"\xa5\x01\n" +
	"\x1eCandidateRestorationCompensate\x122\n" +
	"\x15candidate_artifact_id\x18\x01 \x01(\tR\x13candidateArtifactId\x12\x1d\n" +
	"\n" +
	"service_id\x18\x02 \x01(\tR\tserviceId\x120\n" +
	"\x14candidate_release_id\x18\x03 \x01(\tR\x12candidateReleaseId\"\xf6\x03\n" +
	...
	"\n" +
	"run_script\x18\x1d \x01(\v2\x1f.groundplane.agent.v1.RunScriptH\x00R\trunScript\x12q\n" +
	"\x1bcandidate_restoration_probe\x18  \x01(\v2/.groundplane.agent.v1.CandidateRestorationProbeH\x00R\x19candidateRestorationProbe\x12\x80\x01\n" +
	...
	"\x16runner_snapshot_sha256\x18\v \x01(\fR\x14runnerSnapshotSha256\"\x9e\r\n" +
	...
	"\x0elocal_image_id\x18\x0e \x01(\tR\flocalImageId\x12>\n" +
	"\x1bblueprint_bundle_generation\x18\x10 \x01(\tR\x19blueprintBundleGeneration\x12+\n" +
	"\x11render_generation\x18\x11 \x01(\x04R\x10renderGeneration\x12E\n" +
	...
	"%applied_environment_render_generation\x18\x19 \x01(\x04R\"appliedEnvironmentRenderGeneration\x12R\n" +
	"\x0eservice_source\x18\x1b \x01(\v2+.groundplane.agent.v1.ScriptSourceAuthorityR\rserviceSource\x12c\n" +
	"\x17network_topology_source\x18\x1c \x01(\v2+.groundplane.agent.v1.ScriptSourceAuthorityR\x15networkTopologySource\x12i\n" +
	"\x1aapplied_environment_source\x18\x1d \x01(\v2+.groundplane.agent.v1.ScriptSourceAuthorityR\x18appliedEnvironmentSource\x12e\n" +
	"\x12explicit_execution\x18\x1e \x01(\v26.groundplane.agent.v1.ScriptExplicitExecutionAuthorityR\x11explicitExecutionJ\x04\b\n" +
	"\x10\vJ\x04\b\x12\x10\x13J\x04\b\x1a\x10\x1bR\x14service_mod_revisionR\x19network_topology_revisionR applied_environment_mod_revision\"\xfe\x01\n" +
	" ScriptExplicitExecutionAuthority\x12N\n" +
	"\acontext\x18\x01 \x01(\v24.groundplane.agent.v1.ScriptExplicitExecutionContextR\acontext\x12%\n" +
	"\x0econtext_sha256\x18\x02 \x01(\fR\rcontextSha256\x12.\n" +
	"\x13script_mod_revision\x18\x03 \x01(\x04R\x11scriptModRevision\x123\n" +
	"\x16release_local_image_id\x18\x04 \x01(\tR\x13releaseLocalImageId\"\xc5\x01\n" +
	"\x1eScriptExplicitExecutionContext\x12'\n" +
	"\x0fimage_reference\x18\x01 \x01(\tR\x0eimageReference\x12\x12\n" +
	"\x04user\x18\x02 \x01(\tR\x04user\x12I\n" +
	"\avolumes\x18\x03 \x03(\v2/.groundplane.agent.v1.ScriptExplicitVolumeGrantR\avolumes\x12\x1b\n" +
	"\tentry_ids\x18\x04 \x03(\tR\bentryIds\"m\n" +
	"\x19ScriptExplicitVolumeGrant\x12\x1b\n" +
	"\tvolume_id\x18\x01 \x01(\tR\bvolumeId\x12\x16\n" +
	"\x06target\x18\x02 \x01(\tR\x06target\x12\x1b\n" +
	"\tread_only\x18\x03 \x01(\bR\breadOnly\"\xa7\x02\n" +
	"\x13ScriptRunnerNetwork\x12\x1d\n" +
	"\n" +
	"network_id\x18\x01 \x01(\tR\tnetworkId\x12^\n" +
	"\x13rendered_attachment\x18\x03 \x01(\v2-.groundplane.agent.v1.ScriptNetworkAttachmentR\x12renderedAttachment\x12C\n" +
	"\x06source\x18\x04 \x01(\v2+.groundplane.agent.v1.ScriptSourceAuthorityR\x06source\x120\n" +
	"\x14owner_environment_id\x18\x05 \x01(\tR\x12ownerEnvironmentIdJ\x04\b\x02\x10\x03R\x14network_mod_revision\"\xdb\x01\n" +
	...
	"\bpriority\x18\x04 \x01(\x03R\bpriority\"\xda\x01\n" +
	"\x11ScriptRunnerMount\x12\x1b\n" +
	"\tsource_id\x18\x01 \x01(\tR\bsourceId\x12H\n" +
	"\x0erendered_mount\x18\x03 \x01(\v2!.groundplane.agent.v1.ScriptMountR\rrenderedMount\x12C\n" +
	"\x06source\x18\x04 \x01(\v2+.groundplane.agent.v1.ScriptSourceAuthorityR\x06sourceJ\x04\b\x02\x10\x03R\x13source_mod_revision\"\xb3\x01\n" +
	"\x15ScriptSourceAuthority\x12O\n" +
	"\bexisting\x18\x01 \x01(\v23.groundplane.agent.v1.ScriptExistingSourceAuthorityR\bexisting\x12I\n" +
	"\x06staged\x18\x02 \x01(\v21.groundplane.agent.v1.ScriptStagedSourceAuthorityR\x06staged\"B\n" +
	"\x1dScriptExistingSourceAuthority\x12!\n" +
	"\fmod_revision\x18\x01 \x01(\x04R\vmodRevision\"\xf8\x01\n" +
	"\x1bScriptStagedSourceAuthority\x12%\n" +
	"\x0eenvironment_id\x18\x01 \x01(\tR\renvironmentId\x12\x1f\n" +
	"\vrevision_id\x18\x02 \x01(\tR\n" +
	"revisionId\x12+\n" +
	"\x11render_generation\x18\x03 \x01(\x04R\x10renderGeneration\x12.\n" +
	"\x13fixed_read_revision\x18\x04 \x01(\x04R\x11fixedReadRevision\x124\n" +
	"\x16canonical_value_sha256\x18\x05 \x01(\fR\x14canonicalValueSha256\"\xa2\x04\n" +
	...
	"\bgrant_on\x18\b \x01(\tR\agrantOn\x12S\n" +
	"\x0eauthentication\x18\t \x01(\x0e2+.groundplane.agent.v1.BackingAuthenticationR\x0eauthentication\"\xa6\x03\n" +
	...
	"composeKey\x12#\n" +
	"\rintent_sha256\x18\x04 \x01(\fR\fintentSha256J\x04\b\x05\x10\x06\"\xa5\x02\n" +
	"\x1eVolumeRemovalCheckpointRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x17\n" +
	"\atask_id\x18\x02 \x01(\tR\x06taskId\x12!\n" +
	"\foperation_id\x18\x03 \x01(\tR\voperationId\x12#\n" +
	"\rassignment_id\x18\x04 \x01(\tR\fassignmentId\x12\x17\n" +
	"\astep_id\x18\x05 \x01(\tR\x06stepId\x12\x1b\n" +
	"\tplan_hash\x18\x06 \x01(\fR\bplanHash\x12-\n" +
	"\x12consumers_detached\x18\a \x01(\bR\x11consumersDetached\x12\x1e\n" +
	"\n" +
	"completion\x18\b \x01(\fR\n" +
	"completion\"\xea\x01\n" +
	"\x1aVolumeRemovalCheckpointAck\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x17\n" +
	"\atask_id\x18\x02 \x01(\tR\x06taskId\x12!\n" +
	"\foperation_id\x18\x03 \x01(\tR\voperationId\x12#\n" +
	"\rassignment_id\x18\x04 \x01(\tR\fassignmentId\x12!\n" +
	"\fpending_path\x18\x05 \x01(\fR\vpendingPath\x12)\n" +
	"\x10directory_absent\x18\x06 \x01(\bR\x0fdirectoryAbsent\"}\n" +
	...
	"liveDevice\x12\x1d\n" +
	"\n" +
	"live_inode\x18\b \x01(\x04R\tliveInode\"\xd6\x02\n" +
	...
	"\rassignment_id\x18\a \x01(\tR\fassignmentId\x12=\n" +
	"\x1bvolume_removal_pending_path\x18\b \x01(\fR\x18volumeRemovalPendingPath\"\xc8\x02\n" +
	...
	"\n" +
	"\bShutdown*\x8f\x02\n" +
	"\"WorkloadImageResolutionFailureKind\x126\n" +
	...
	"\x1cLOG_END_REASON_SOURCE_FAILED\x10\x04*\xaa\x01\n" +
	"\x14ReleaseRecoveryPhase\x12&\n" +
	"\"RELEASE_RECOVERY_PHASE_UNSPECIFIED\x10\x00\x12 \n" +
	"\x1cRELEASE_RECOVERY_PHASE_PROBE\x10\x01\x12%\n" +
	"!RELEASE_RECOVERY_PHASE_COMPENSATE\x10\x02\x12!\n" +
	"\x1dRELEASE_RECOVERY_PHASE_PROVEN\x10\x03*\x80\x01\n" +
	"\x11TaskExecutionMode\x12#\n" +
	"\x1fTASK_EXECUTION_MODE_UNSPECIFIED\x10\x00\x12\x1f\n" +
	"\x1bTASK_EXECUTION_MODE_FORWARD\x10\x01\x12%\n" +
	"!TASK_EXECUTION_MODE_RECOVERY_ONLY\x10\x02*\xac\x01\n" +
	"\x18ReleaseRestorationTarget\x12*\n" +
	"&RELEASE_RESTORATION_TARGET_UNSPECIFIED\x10\x00\x122\n" +
	".RELEASE_RESTORATION_TARGET_SERVING_PREDECESSOR\x10\x01\x120\n" +
	",RELEASE_RESTORATION_TARGET_CANDIDATE_ABSENCE\x10\x02*\xc3\x02\n" +
	...
	"0SCRIPT_OUTCOME_REASON_RECOVERY_INVARIANT_FAILURE\x10\t*\xbc\x01\n" +
	"\x10BackingHookEvent\x12\"\n" +
	"\x1eBACKING_HOOK_EVENT_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19BACKING_HOOK_EVENT_ATTACH\x10\x01\x12\x1d\n" +
	"\x19BACKING_HOOK_EVENT_DETACH\x10\x02\x12\"\n" +
	"\x1eBACKING_HOOK_EVENT_BEFORE_STOP\x10\x03\x12\"\n" +
	"\x1eBACKING_HOOK_EVENT_AFTER_START\x10\x04*\xa0\x01\n" +
	"\x1aBackingHookCheckpointState\x12-\n" +
	")BACKING_HOOK_CHECKPOINT_STATE_UNSPECIFIED\x10\x00\x12)\n" +
	"%BACKING_HOOK_CHECKPOINT_STATE_STARTED\x10\x01\x12(\n" +
	"$BACKING_HOOK_CHECKPOINT_STATE_RESULT\x10\x02*\xb2\x01\n" +
	...
	"\x1eADAPTER_PROCEDURE_PHASE_REVOKE\x10\x04*\xb3\x01\n" +
	"\x15BackingAuthentication\x12&\n" +
	"\"BACKING_AUTHENTICATION_UNSPECIFIED\x10\x00\x12,\n" +
	"(BACKING_AUTHENTICATION_USERNAME_PASSWORD\x10\x01\x12#\n" +
	"\x1fBACKING_AUTHENTICATION_PASSWORD\x10\x02\x12\x1f\n" +
	"\x1bBACKING_AUTHENTICATION_NONE\x10\x03*\xed\x02\n" +
	...
	"\x1dCOMPOSE_HELPER_OUTCOME_FAILED\x10\x02\x12/\n" +
	"+COMPOSE_HELPER_OUTCOME_RESTORATION_REQUIRED\x10\x03*\xb9\x02\n" +
...
var file_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 177)
var file_proto_agent_proto_goTypes = []any{
	...
	(*LogReady)(nil),                                  // 73: groundplane.agent.v1.LogReady
	(*LogEvent)(nil),                                  // 74: groundplane.agent.v1.LogEvent
	(*LogEnd)(nil),                                    // 75: groundplane.agent.v1.LogEnd
	(*MaterializationTransfer)(nil),                   // 76: groundplane.agent.v1.MaterializationTransfer
	(*MaterializationTransferHeader)(nil),             // 77: groundplane.agent.v1.MaterializationTransferHeader
	(*MaterializationTransferChunk)(nil),              // 78: groundplane.agent.v1.MaterializationTransferChunk
	(*MaterializationTransferEnd)(nil),                // 79: groundplane.agent.v1.MaterializationTransferEnd
	(*ManagedConfigTransfer)(nil),                     // 80: groundplane.agent.v1.ManagedConfigTransfer
	(*ManagedConfigTransferHeader)(nil),               // 81: groundplane.agent.v1.ManagedConfigTransferHeader
	(*ManagedConfigTransferChunk)(nil),                // 82: groundplane.agent.v1.ManagedConfigTransferChunk
	(*ManagedConfigTransferEnd)(nil),                  // 83: groundplane.agent.v1.ManagedConfigTransferEnd
	(*TaskAssignment)(nil),                            // 84: groundplane.agent.v1.TaskAssignment
	(*ReleaseRecoveryDirective)(nil),                  // 85: groundplane.agent.v1.ReleaseRecoveryDirective
	(*ReleaseRestorationCandidate)(nil),               // 86: groundplane.agent.v1.ReleaseRestorationCandidate
	(*ReleaseAppliedPredecessorAuthority)(nil),        // 87: groundplane.agent.v1.ReleaseAppliedPredecessorAuthority
	(*ReleaseRestorationAuthority)(nil),               // 88: groundplane.agent.v1.ReleaseRestorationAuthority
	(*ReleaseNativePredecessorAuthority)(nil),         // 89: groundplane.agent.v1.ReleaseNativePredecessorAuthority
	(*ScriptStartAuthorizedCheckpoint)(nil),           // 90: groundplane.agent.v1.ScriptStartAuthorizedCheckpoint
	(*ScriptBodyPreparedCheckpoint)(nil),              // 91: groundplane.agent.v1.ScriptBodyPreparedCheckpoint
	(*ScriptContainerCreatedCheckpoint)(nil),          // 92: groundplane.agent.v1.ScriptContainerCreatedCheckpoint
	(*ScriptOutcomeCheckpoint)(nil),                   // 93: groundplane.agent.v1.ScriptOutcomeCheckpoint
	(*ScriptCleanupCheckpoint)(nil),                   // 94: groundplane.agent.v1.ScriptCleanupCheckpoint
	(*ScriptExecutionCheckpoint)(nil),                 // 95: groundplane.agent.v1.ScriptExecutionCheckpoint
	(*ScriptCheckpointRequest)(nil),                   // 96: groundplane.agent.v1.ScriptCheckpointRequest
	(*ScriptCheckpointAck)(nil),                       // 97: groundplane.agent.v1.ScriptCheckpointAck
	(*BackingHookValue)(nil),                          // 98: groundplane.agent.v1.BackingHookValue
	(*BackingHookFactDefinition)(nil),                 // 99: groundplane.agent.v1.BackingHookFactDefinition
	(*BackingHookProcedure)(nil),                      // 100: groundplane.agent.v1.BackingHookProcedure
	(*BackingHookCheckpointRequest)(nil),              // 101: groundplane.agent.v1.BackingHookCheckpointRequest
	(*BackingHookCheckpointAck)(nil),                  // 102: groundplane.agent.v1.BackingHookCheckpointAck
	(*ExecutionPlan)(nil),                             // 103: groundplane.agent.v1.ExecutionPlan
	(*EntryMutationProcedure)(nil),                    // 104: groundplane.agent.v1.EntryMutationProcedure
	(*ServiceLifecycleProcedure)(nil),                 // 105: groundplane.agent.v1.ServiceLifecycleProcedure
	(*ServiceLifecycleSource)(nil),                    // 106: groundplane.agent.v1.ServiceLifecycleSource
	(*ManagedComponentProcedure)(nil),                 // 107: groundplane.agent.v1.ManagedComponentProcedure
	(*ManagedComponentService)(nil),                   // 108: groundplane.agent.v1.ManagedComponentService
	(*CandidateReleaseProcedure)(nil),                 // 109: groundplane.agent.v1.CandidateReleaseProcedure
	(*ConfigurationRestoration)(nil),                  // 110: groundplane.agent.v1.ConfigurationRestoration
	(*ConfigurationFileRestoration)(nil),              // 111: groundplane.agent.v1.ConfigurationFileRestoration
	(*CandidateReleaseMember)(nil),                    // 112: groundplane.agent.v1.CandidateReleaseMember
	(*ServingPredecessorRestoration)(nil),             // 113: groundplane.agent.v1.ServingPredecessorRestoration
	(*CandidateAbsenceRestoration)(nil),               // 114: groundplane.agent.v1.CandidateAbsenceRestoration
	(*CandidateReleaseService)(nil),                   // 115: groundplane.agent.v1.CandidateReleaseService
	(*CandidateRestorationProbe)(nil),                 // 116: groundplane.agent.v1.CandidateRestorationProbe
	(*CandidateRestorationCompensate)(nil),            // 117: groundplane.agent.v1.CandidateRestorationCompensate
	(*ComposeArtifact)(nil),                           // 118: groundplane.agent.v1.ComposeArtifact
	(*ComposeService)(nil),                            // 119: groundplane.agent.v1.ComposeService
	(*ComposeNetwork)(nil),                            // 120: groundplane.agent.v1.ComposeNetwork
	(*ComposeVolume)(nil),                             // 121: groundplane.agent.v1.ComposeVolume
	(*LabelPair)(nil),                                 // 122: groundplane.agent.v1.LabelPair
	(*ExecutionStep)(nil),                             // 123: groundplane.agent.v1.ExecutionStep
	(*ManagedNetworkEnsure)(nil),                      // 124: groundplane.agent.v1.ManagedNetworkEnsure
	(*ManagedVolumeEnsure)(nil),                       // 125: groundplane.agent.v1.ManagedVolumeEnsure
	(*RunScript)(nil),                                 // 126: groundplane.agent.v1.RunScript
	(*ResolvedRunnerSnapshot)(nil),                    // 127: groundplane.agent.v1.ResolvedRunnerSnapshot
	(*ScriptExplicitExecutionAuthority)(nil),          // 128: groundplane.agent.v1.ScriptExplicitExecutionAuthority
	(*ScriptExplicitExecutionContext)(nil),            // 129: groundplane.agent.v1.ScriptExplicitExecutionContext
	(*ScriptExplicitVolumeGrant)(nil),                 // 130: groundplane.agent.v1.ScriptExplicitVolumeGrant
	(*ScriptRunnerNetwork)(nil),                       // 131: groundplane.agent.v1.ScriptRunnerNetwork
	(*ScriptNetworkAttachment)(nil),                   // 132: groundplane.agent.v1.ScriptNetworkAttachment
	(*ScriptRunnerMount)(nil),                         // 133: groundplane.agent.v1.ScriptRunnerMount
	(*ScriptSourceAuthority)(nil),                     // 134: groundplane.agent.v1.ScriptSourceAuthority
	(*ScriptExistingSourceAuthority)(nil),             // 135: groundplane.agent.v1.ScriptExistingSourceAuthority
	(*ScriptStagedSourceAuthority)(nil),               // 136: groundplane.agent.v1.ScriptStagedSourceAuthority
	(*ScriptMount)(nil),                               // 137: groundplane.agent.v1.ScriptMount
	(*ScriptRunnerEntryBinding)(nil),                  // 138: groundplane.agent.v1.ScriptRunnerEntryBinding
	(*ScriptRunnerSecretValue)(nil),                   // 139: groundplane.agent.v1.ScriptRunnerSecretValue
	(*ScriptRunnerProjection)(nil),                    // 140: groundplane.agent.v1.ScriptRunnerProjection
	(*ScriptStringPair)(nil),                          // 141: groundplane.agent.v1.ScriptStringPair
	(*ScriptUlimit)(nil),                              // 142: groundplane.agent.v1.ScriptUlimit
	(*ScriptBlkio)(nil),                               // 143: groundplane.agent.v1.ScriptBlkio
	(*ScriptWeightDevice)(nil),                        // 144: groundplane.agent.v1.ScriptWeightDevice
	(*ScriptThrottleDevice)(nil),                      // 145: groundplane.agent.v1.ScriptThrottleDevice
	(*ScriptResource)(nil),                            // 146: groundplane.agent.v1.ScriptResource
	(*ScriptBodyArtifactMetadata)(nil),                // 147: groundplane.agent.v1.ScriptBodyArtifactMetadata
	(*ScriptAssignmentArtifacts)(nil),                 // 148: groundplane.agent.v1.ScriptAssignmentArtifacts
	(*ScriptBodyArtifact)(nil),                        // 149: groundplane.agent.v1.ScriptBodyArtifact
	(*ScriptSecretArtifact)(nil),                      // 150: groundplane.agent.v1.ScriptSecretArtifact
	(*ScriptEntryArtifact)(nil),                       // 151: groundplane.agent.v1.ScriptEntryArtifact
	(*BackupSourceCapture)(nil),                       // 152: groundplane.agent.v1.BackupSourceCapture
	(*BackupUploadAuthority)(nil),                     // 153: groundplane.agent.v1.BackupUploadAuthority
	(*BackupArtifactPrune)(nil),                       // 154: groundplane.agent.v1.BackupArtifactPrune
	(*BackupAttachSource)(nil),                        // 155: groundplane.agent.v1.BackupAttachSource
	(*BackupConfigSource)(nil),                        // 156: groundplane.agent.v1.BackupConfigSource
	(*BackupVolumeSource)(nil),                        // 157: groundplane.agent.v1.BackupVolumeSource
	(*BackupVolumeService)(nil),                       // 158: groundplane.agent.v1.BackupVolumeService
	(*BackupCheckpointRequest)(nil),                   // 159: groundplane.agent.v1.BackupCheckpointRequest
	(*BackupCheckpointAck)(nil),                       // 160: groundplane.agent.v1.BackupCheckpointAck
	(*BackupSecretSlotTransfer)(nil),                  // 161: groundplane.agent.v1.BackupSecretSlotTransfer
	(*BackupSecretSlotHeader)(nil),                    // 162: groundplane.agent.v1.BackupSecretSlotHeader
	(*BackupSecretSlotChunk)(nil),                     // 163: groundplane.agent.v1.BackupSecretSlotChunk
	(*BackupSecretSlotEnd)(nil),                       // 164: groundplane.agent.v1.BackupSecretSlotEnd
	(*BackupArtifactPreparedCheckpoint)(nil),          // 165: groundplane.agent.v1.BackupArtifactPreparedCheckpoint
	(*BackupUploadCompletedCheckpoint)(nil),           // 166: groundplane.agent.v1.BackupUploadCompletedCheckpoint
	(*BackupUploadVerifiedCheckpoint)(nil),            // 167: groundplane.agent.v1.BackupUploadVerifiedCheckpoint
	(*BackupSourceCleanupCompletedCheckpoint)(nil),    // 168: groundplane.agent.v1.BackupSourceCleanupCompletedCheckpoint
	(*BackupRestoreArtifactValidatedCheckpoint)(nil),  // 169: groundplane.agent.v1.BackupRestoreArtifactValidatedCheckpoint
	(*BackupVolumeTreeStagedCheckpoint)(nil),          // 170: groundplane.agent.v1.BackupVolumeTreeStagedCheckpoint
	(*BackupVolumeTreeExchangedCheckpoint)(nil),       // 171: groundplane.agent.v1.BackupVolumeTreeExchangedCheckpoint
	(*BackupVolumeReplacedTreeCleanedCheckpoint)(nil), // 172: groundplane.agent.v1.BackupVolumeReplacedTreeCleanedCheckpoint
	(*BackupConfigGenerationStagedCheckpoint)(nil),    // 173: groundplane.agent.v1.BackupConfigGenerationStagedCheckpoint
	(*BackupConfigGenerationActivatedCheckpoint)(nil), // 174: groundplane.agent.v1.BackupConfigGenerationActivatedCheckpoint
	(*BackupPostgresRestoreVerifiedCheckpoint)(nil),   // 175: groundplane.agent.v1.BackupPostgresRestoreVerifiedCheckpoint
	(*BackupRemoteObjectAbsentCheckpoint)(nil),        // 176: groundplane.agent.v1.BackupRemoteObjectAbsentCheckpoint
	(*AdapterProcedure)(nil),                          // 177: groundplane.agent.v1.AdapterProcedure
	(*MaterializeFile)(nil),                           // 178: groundplane.agent.v1.MaterializeFile
	(*ComposeApply)(nil),                              // 179: groundplane.agent.v1.ComposeApply
	(*ComposeStop)(nil),                               // 180: groundplane.agent.v1.ComposeStop
	(*ComposeRemove)(nil),                             // 181: groundplane.agent.v1.ComposeRemove
	(*WaitHealthy)(nil),                               // 182: groundplane.agent.v1.WaitHealthy
	(*ComposeWorkloadApply)(nil),                      // 183: groundplane.agent.v1.ComposeWorkloadApply
	(*WaitWorkloadHealthy)(nil),                       // 184: groundplane.agent.v1.WaitWorkloadHealthy
	(*ServiceProxySwitch)(nil),                        // 185: groundplane.agent.v1.ServiceProxySwitch
	(*ServiceProxyProbe)(nil),                         // 186: groundplane.agent.v1.ServiceProxyProbe
	(*ServiceProxyCompensate)(nil),                    // 187: groundplane.agent.v1.ServiceProxyCompensate
	(*ServiceProxyEvidence)(nil),                      // 188: groundplane.agent.v1.ServiceProxyEvidence
	(*ServiceRecreateAcknowledge)(nil),                // 189: groundplane.agent.v1.ServiceRecreateAcknowledge
	(*ServiceRecreateProbe)(nil),                      // 190: groundplane.agent.v1.ServiceRecreateProbe
	(*ServiceRecreateCompensate)(nil),                 // 191: groundplane.agent.v1.ServiceRecreateCompensate
	(*ServiceRecreateEvidence)(nil),                   // 192: groundplane.agent.v1.ServiceRecreateEvidence
	(*EnvironmentDirectoryCreate)(nil),                // 193: groundplane.agent.v1.EnvironmentDirectoryCreate
	(*EnvironmentDirectoryRemove)(nil),                // 194: groundplane.agent.v1.EnvironmentDirectoryRemove
	(*ManagedVolumeDirectoriesEnsure)(nil),            // 195: groundplane.agent.v1.ManagedVolumeDirectoriesEnsure
	(*ManagedVolumeRemove)(nil),                       // 196: groundplane.agent.v1.ManagedVolumeRemove
	(*ManagedVolumeDirectoryRemove)(nil),              // 197: groundplane.agent.v1.ManagedVolumeDirectoryRemove
	(*VolumeRemovalCheckpointRequest)(nil),            // 198: groundplane.agent.v1.VolumeRemovalCheckpointRequest
	(*VolumeRemovalCheckpointAck)(nil),                // 199: groundplane.agent.v1.VolumeRemovalCheckpointAck
	(*ManagedNetworkRemove)(nil),                      // 200: groundplane.agent.v1.ManagedNetworkRemove
	(*ComponentApply)(nil),                            // 201: groundplane.agent.v1.ComponentApply
	(*HostResolutionApply)(nil),                       // 202: groundplane.agent.v1.HostResolutionApply
	(*HostResolutionRestore)(nil),                     // 203: groundplane.agent.v1.HostResolutionRestore
	(*ManagedConfigHelperRequest)(nil),                // 204: groundplane.agent.v1.ManagedConfigHelperRequest
	(*ManagedConfigHelperResponse)(nil),               // 205: groundplane.agent.v1.ManagedConfigHelperResponse
	(*EnvironmentDirectoryHelperRequest)(nil),         // 206: groundplane.agent.v1.EnvironmentDirectoryHelperRequest
	(*EnvironmentDirectoryHelperResponse)(nil),        // 207: groundplane.agent.v1.EnvironmentDirectoryHelperResponse
	(*ComposeHelperRequest)(nil),                      // 208: groundplane.agent.v1.ComposeHelperRequest
	(*ComposeHelperResponse)(nil),                     // 209: groundplane.agent.v1.ComposeHelperResponse
	(*TaskAbort)(nil),                                 // 210: groundplane.agent.v1.TaskAbort
	(*ConfigUpdate)(nil),                              // 211: groundplane.agent.v1.ConfigUpdate
	(*Shutdown)(nil),                                  // 212: groundplane.agent.v1.Shutdown
	nil,                                               // 213: groundplane.agent.v1.AgentConfig.LabelsEntry
	(*timestamppb.Timestamp)(nil),                     // 214: google.protobuf.Timestamp
}
var file_proto_agent_proto_depIdxs = []int32{
	213, // 0: groundplane.agent.v1.AgentConfig.labels:type_name -> groundplane.agent.v1.AgentConfig.LabelsEntry
	...
	159, // 6: groundplane.agent.v1.AgentMessage.backup_checkpoint_request:type_name -> groundplane.agent.v1.BackupCheckpointRequest
	74,  // 7: groundplane.agent.v1.AgentMessage.log_event:type_name -> groundplane.agent.v1.LogEvent
	75,  // 8: groundplane.agent.v1.AgentMessage.log_end:type_name -> groundplane.agent.v1.LogEnd
	73,  // 9: groundplane.agent.v1.AgentMessage.log_ready:type_name -> groundplane.agent.v1.LogReady
	96,  // 10: groundplane.agent.v1.AgentMessage.script_checkpoint_request:type_name -> groundplane.agent.v1.ScriptCheckpointRequest
	...
	198, // 12: groundplane.agent.v1.AgentMessage.volume_removal_checkpoint_request:type_name -> groundplane.agent.v1.VolumeRemovalCheckpointRequest
	...
	101, // 14: groundplane.agent.v1.AgentMessage.backing_hook_checkpoint_request:type_name -> groundplane.agent.v1.BackingHookCheckpointRequest
	...
	214, // 28: groundplane.agent.v1.ObservedProject.observed_at:type_name -> google.protobuf.Timestamp
	...
	122, // 35: groundplane.agent.v1.ObservedContainer.labels:type_name -> groundplane.agent.v1.LabelPair
	122, // 36: groundplane.agent.v1.ObservedNetwork.labels:type_name -> groundplane.agent.v1.LabelPair
	122, // 37: groundplane.agent.v1.ObservedVolume.labels:type_name -> groundplane.agent.v1.LabelPair
	...
	188, // 44: groundplane.agent.v1.ComposeTaskResult.proxy_evidence:type_name -> groundplane.agent.v1.ServiceProxyEvidence
	192, // 45: groundplane.agent.v1.ComposeTaskResult.recreate_evidence:type_name -> groundplane.agent.v1.ServiceRecreateEvidence
	...
	115, // 49: groundplane.agent.v1.CandidateAbsenceEvidence.candidates:type_name -> groundplane.agent.v1.CandidateReleaseService
	214, // 50: groundplane.agent.v1.DNSResolverObservationEvidence.observed_at:type_name -> google.protobuf.Timestamp
	...
	84,  // 58: groundplane.agent.v1.ControllerMessage.task_assignment:type_name -> groundplane.agent.v1.TaskAssignment
	210, // 59: groundplane.agent.v1.ControllerMessage.task_abort:type_name -> groundplane.agent.v1.TaskAbort
	211, // 60: groundplane.agent.v1.ControllerMessage.config_update:type_name -> groundplane.agent.v1.ConfigUpdate
	212, // 61: groundplane.agent.v1.ControllerMessage.shutdown:type_name -> groundplane.agent.v1.Shutdown
	76,  // 62: groundplane.agent.v1.ControllerMessage.materialization_transfer:type_name -> groundplane.agent.v1.MaterializationTransfer
	160, // 63: groundplane.agent.v1.ControllerMessage.backup_checkpoint_ack:type_name -> groundplane.agent.v1.BackupCheckpointAck
	161, // 64: groundplane.agent.v1.ControllerMessage.backup_secret_slot_transfer:type_name -> groundplane.agent.v1.BackupSecretSlotTransfer
	...
	80,  // 67: groundplane.agent.v1.ControllerMessage.managed_config_transfer:type_name -> groundplane.agent.v1.ManagedConfigTransfer
	97,  // 68: groundplane.agent.v1.ControllerMessage.script_checkpoint_ack:type_name -> groundplane.agent.v1.ScriptCheckpointAck
	...
	199, // 70: groundplane.agent.v1.ControllerMessage.volume_removal_checkpoint_ack:type_name -> groundplane.agent.v1.VolumeRemovalCheckpointAck
	...
	102, // 73: groundplane.agent.v1.ControllerMessage.backing_hook_checkpoint_ack:type_name -> groundplane.agent.v1.BackingHookCheckpointAck
	54,  // 74: groundplane.agent.v1.ControllerMessage.task_event_ack:type_name -> groundplane.agent.v1.TaskEventAck
	70,  // 75: groundplane.agent.v1.LogSubscribe.targets:type_name -> groundplane.agent.v1.LogTarget
	9,   // 76: groundplane.agent.v1.LogEvent.slot:type_name -> groundplane.agent.v1.LogSlot
	8,   // 77: groundplane.agent.v1.LogEvent.stream:type_name -> groundplane.agent.v1.LogStream
	214, // 78: groundplane.agent.v1.LogEvent.timestamp:type_name -> google.protobuf.Timestamp
	10,  // 79: groundplane.agent.v1.LogEnd.reason:type_name -> groundplane.agent.v1.LogEndReason
	77,  // 80: groundplane.agent.v1.MaterializationTransfer.header:type_name -> groundplane.agent.v1.MaterializationTransferHeader
	78,  // 81: groundplane.agent.v1.MaterializationTransfer.chunk:type_name -> groundplane.agent.v1.MaterializationTransferChunk
	79,  // 82: groundplane.agent.v1.MaterializationTransfer.end:type_name -> groundplane.agent.v1.MaterializationTransferEnd
	32,  // 83: groundplane.agent.v1.MaterializationTransferHeader.output_kind:type_name -> groundplane.agent.v1.MaterializationOutputKind
	81,  // 84: groundplane.agent.v1.ManagedConfigTransfer.header:type_name -> groundplane.agent.v1.ManagedConfigTransferHeader
	82,  // 85: groundplane.agent.v1.ManagedConfigTransfer.chunk:type_name -> groundplane.agent.v1.ManagedConfigTransferChunk
	83,  // 86: groundplane.agent.v1.ManagedConfigTransfer.end:type_name -> groundplane.agent.v1.ManagedConfigTransferEnd
	103, // 87: groundplane.agent.v1.TaskAssignment.plan:type_name -> groundplane.agent.v1.ExecutionPlan
	214, // 88: groundplane.agent.v1.TaskAssignment.forward_deadline:type_name -> google.protobuf.Timestamp
	148, // 89: groundplane.agent.v1.TaskAssignment.script_artifacts:type_name -> groundplane.agent.v1.ScriptAssignmentArtifacts
	95,  // 90: groundplane.agent.v1.TaskAssignment.script_checkpoints:type_name -> groundplane.agent.v1.ScriptExecutionCheckpoint
	12,  // 91: groundplane.agent.v1.TaskAssignment.execution_mode:type_name -> groundplane.agent.v1.TaskExecutionMode
	214, // 92: groundplane.agent.v1.TaskAssignment.recovery_deadline:type_name -> google.protobuf.Timestamp
	88,  // 93: groundplane.agent.v1.TaskAssignment.restoration_authority:type_name -> groundplane.agent.v1.ReleaseRestorationAuthority
	85,  // 94: groundplane.agent.v1.TaskAssignment.release_recovery_directive:type_name -> groundplane.agent.v1.ReleaseRecoveryDirective
	214, // 95: groundplane.agent.v1.TaskAssignment.execution_deadline:type_name -> google.protobuf.Timestamp
	11,  // 96: groundplane.agent.v1.ReleaseRecoveryDirective.phase:type_name -> groundplane.agent.v1.ReleaseRecoveryPhase
	13,  // 97: groundplane.agent.v1.ReleaseRestorationCandidate.target:type_name -> groundplane.agent.v1.ReleaseRestorationTarget
	86,  // 98: groundplane.agent.v1.ReleaseRestorationAuthority.candidates:type_name -> groundplane.agent.v1.ReleaseRestorationCandidate
	87,  // 99: groundplane.agent.v1.ReleaseRestorationAuthority.applied_predecessor:type_name -> groundplane.agent.v1.ReleaseAppliedPredecessorAuthority
	89,  // 100: groundplane.agent.v1.ReleaseRestorationAuthority.native_predecessors:type_name -> groundplane.agent.v1.ReleaseNativePredecessorAuthority
	15,  // 101: groundplane.agent.v1.ScriptOutcomeCheckpoint.reason:type_name -> groundplane.agent.v1.ScriptOutcomeReason
	214, // 102: groundplane.agent.v1.ScriptOutcomeCheckpoint.observed_at:type_name -> google.protobuf.Timestamp
	14,  // 103: groundplane.agent.v1.ScriptExecutionCheckpoint.state:type_name -> groundplane.agent.v1.ScriptExecutionState
	91,  // 104: groundplane.agent.v1.ScriptExecutionCheckpoint.body_prepared:type_name -> groundplane.agent.v1.ScriptBodyPreparedCheckpoint
	92,  // 105: groundplane.agent.v1.ScriptExecutionCheckpoint.container_created:type_name -> groundplane.agent.v1.ScriptContainerCreatedCheckpoint
	93,  // 106: groundplane.agent.v1.ScriptExecutionCheckpoint.outcome:type_name -> groundplane.agent.v1.ScriptOutcomeCheckpoint
	94,  // 107: groundplane.agent.v1.ScriptExecutionCheckpoint.cleanup:type_name -> groundplane.agent.v1.ScriptCleanupCheckpoint
	14,  // 108: groundplane.agent.v1.ScriptCheckpointRequest.expected_state:type_name -> groundplane.agent.v1.ScriptExecutionState
	14,  // 109: groundplane.agent.v1.ScriptCheckpointRequest.state:type_name -> groundplane.agent.v1.ScriptExecutionState
	90,  // 110: groundplane.agent.v1.ScriptCheckpointRequest.start_authorized:type_name -> groundplane.agent.v1.ScriptStartAuthorizedCheckpoint
	91,  // 111: groundplane.agent.v1.ScriptCheckpointRequest.body_prepared:type_name -> groundplane.agent.v1.ScriptBodyPreparedCheckpoint
	92,  // 112: groundplane.agent.v1.ScriptCheckpointRequest.container_created:type_name -> groundplane.agent.v1.ScriptContainerCreatedCheckpoint
	93,  // 113: groundplane.agent.v1.ScriptCheckpointRequest.outcome:type_name -> groundplane.agent.v1.ScriptOutcomeCheckpoint
	94,  // 114: groundplane.agent.v1.ScriptCheckpointRequest.cleanup:type_name -> groundplane.agent.v1.ScriptCleanupCheckpoint
	14,  // 115: groundplane.agent.v1.ScriptCheckpointAck.state:type_name -> groundplane.agent.v1.ScriptExecutionState
	16,  // 116: groundplane.agent.v1.BackingHookProcedure.event:type_name -> groundplane.agent.v1.BackingHookEvent
	98,  // 117: groundplane.agent.v1.BackingHookProcedure.inputs:type_name -> groundplane.agent.v1.BackingHookValue
	98,  // 118: groundplane.agent.v1.BackingHookProcedure.facts:type_name -> groundplane.agent.v1.BackingHookValue
	99,  // 119: groundplane.agent.v1.BackingHookProcedure.fact_schema:type_name -> groundplane.agent.v1.BackingHookFactDefinition
	16,  // 120: groundplane.agent.v1.BackingHookCheckpointRequest.event:type_name -> groundplane.agent.v1.BackingHookEvent
	17,  // 121: groundplane.agent.v1.BackingHookCheckpointRequest.state:type_name -> groundplane.agent.v1.BackingHookCheckpointState
	98,  // 122: groundplane.agent.v1.BackingHookCheckpointRequest.facts:type_name -> groundplane.agent.v1.BackingHookValue
	16,  // 123: groundplane.agent.v1.BackingHookCheckpointAck.event:type_name -> groundplane.agent.v1.BackingHookEvent
	17,  // 124: groundplane.agent.v1.BackingHookCheckpointAck.state:type_name -> groundplane.agent.v1.BackingHookCheckpointState
	19,  // 125: groundplane.agent.v1.ExecutionPlan.operation:type_name -> groundplane.agent.v1.PlanOperation
	118, // 126: groundplane.agent.v1.ExecutionPlan.artifacts:type_name -> groundplane.agent.v1.ComposeArtifact
	123, // 127: groundplane.agent.v1.ExecutionPlan.steps:type_name -> groundplane.agent.v1.ExecutionStep
	127, // 128: groundplane.agent.v1.ExecutionPlan.script_runner_snapshots:type_name -> groundplane.agent.v1.ResolvedRunnerSnapshot
	140, // 129: groundplane.agent.v1.ExecutionPlan.script_runner_projections:type_name -> groundplane.agent.v1.ScriptRunnerProjection
	147, // 130: groundplane.agent.v1.ExecutionPlan.script_body_artifacts:type_name -> groundplane.agent.v1.ScriptBodyArtifactMetadata
	18,  // 131: groundplane.agent.v1.ExecutionPlan.component_lifecycle_mode:type_name -> groundplane.agent.v1.ComponentLifecycleMode
	201, // 132: groundplane.agent.v1.ExecutionPlan.component_rollback_observation:type_name -> groundplane.agent.v1.ComponentApply
	109, // 133: groundplane.agent.v1.ExecutionPlan.candidate_release_procedure:type_name -> groundplane.agent.v1.CandidateReleaseProcedure
	107, // 134: groundplane.agent.v1.ExecutionPlan.managed_component_procedure:type_name -> groundplane.agent.v1.ManagedComponentProcedure
	105, // 135: groundplane.agent.v1.ExecutionPlan.service_lifecycle_procedure:type_name -> groundplane.agent.v1.ServiceLifecycleProcedure
	104, // 136: groundplane.agent.v1.ExecutionPlan.entry_mutation_procedure:type_name -> groundplane.agent.v1.EntryMutationProcedure
	106, // 137: groundplane.agent.v1.ServiceLifecycleProcedure.sources:type_name -> groundplane.agent.v1.ServiceLifecycleSource
	108, // 138: groundplane.agent.v1.ManagedComponentProcedure.services:type_name -> groundplane.agent.v1.ManagedComponentService
	112, // 139: groundplane.agent.v1.CandidateReleaseProcedure.members:type_name -> groundplane.agent.v1.CandidateReleaseMember
	110, // 140: groundplane.agent.v1.CandidateReleaseProcedure.configuration_restoration:type_name -> groundplane.agent.v1.ConfigurationRestoration
	111, // 141: groundplane.agent.v1.ConfigurationRestoration.files:type_name -> groundplane.agent.v1.ConfigurationFileRestoration
	113, // 142: groundplane.agent.v1.CandidateReleaseMember.serving_predecessor:type_name -> groundplane.agent.v1.ServingPredecessorRestoration
	114, // 143: groundplane.agent.v1.CandidateReleaseMember.candidate_absence:type_name -> groundplane.agent.v1.CandidateAbsenceRestoration
	115, // 144: groundplane.agent.v1.CandidateAbsenceRestoration.services:type_name -> groundplane.agent.v1.CandidateReleaseService
	20,  // 145: groundplane.agent.v1.ComposeArtifact.owner_kind:type_name -> groundplane.agent.v1.ComposeOwnerKind
	119, // 146: groundplane.agent.v1.ComposeArtifact.services:type_name -> groundplane.agent.v1.ComposeService
	120, // 147: groundplane.agent.v1.ComposeArtifact.networks:type_name -> groundplane.agent.v1.ComposeNetwork
	121, // 148: groundplane.agent.v1.ComposeArtifact.volumes:type_name -> groundplane.agent.v1.ComposeVolume
	122, // 149: groundplane.agent.v1.ComposeService.expected_labels:type_name -> groundplane.agent.v1.LabelPair
	21,  // 150: groundplane.agent.v1.ComposeService.role:type_name -> groundplane.agent.v1.ComposeServiceRole
	122, // 151: groundplane.agent.v1.ComposeNetwork.expected_labels:type_name -> groundplane.agent.v1.LabelPair
	122, // 152: groundplane.agent.v1.ComposeVolume.expected_labels:type_name -> groundplane.agent.v1.LabelPair
	179, // 153: groundplane.agent.v1.ExecutionStep.compose_apply:type_name -> groundplane.agent.v1.ComposeApply
	180, // 154: groundplane.agent.v1.ExecutionStep.compose_stop:type_name -> groundplane.agent.v1.ComposeStop
	181, // 155: groundplane.agent.v1.ExecutionStep.compose_remove:type_name -> groundplane.agent.v1.ComposeRemove
	182, // 156: groundplane.agent.v1.ExecutionStep.wait_healthy:type_name -> groundplane.agent.v1.WaitHealthy
	193, // 157: groundplane.agent.v1.ExecutionStep.environment_directory_create:type_name -> groundplane.agent.v1.EnvironmentDirectoryCreate
	178, // 158: groundplane.agent.v1.ExecutionStep.materialize_file:type_name -> groundplane.agent.v1.MaterializeFile
	195, // 159: groundplane.agent.v1.ExecutionStep.managed_volume_directories_ensure:type_name -> groundplane.agent.v1.ManagedVolumeDirectoriesEnsure
	194, // 160: groundplane.agent.v1.ExecutionStep.environment_directory_remove:type_name -> groundplane.agent.v1.EnvironmentDirectoryRemove
	177, // 161: groundplane.agent.v1.ExecutionStep.adapter_procedure:type_name -> groundplane.agent.v1.AdapterProcedure
	200, // 162: groundplane.agent.v1.ExecutionStep.managed_network_remove:type_name -> groundplane.agent.v1.ManagedNetworkRemove
	152, // 163: groundplane.agent.v1.ExecutionStep.backup_source_capture:type_name -> groundplane.agent.v1.BackupSourceCapture
	154, // 164: groundplane.agent.v1.ExecutionStep.backup_artifact_prune:type_name -> groundplane.agent.v1.BackupArtifactPrune
	183, // 165: groundplane.agent.v1.ExecutionStep.compose_workload_apply:type_name -> groundplane.agent.v1.ComposeWorkloadApply
	184, // 166: groundplane.agent.v1.ExecutionStep.wait_workload_healthy:type_name -> groundplane.agent.v1.WaitWorkloadHealthy
	185, // 167: groundplane.agent.v1.ExecutionStep.service_proxy_switch:type_name -> groundplane.agent.v1.ServiceProxySwitch
	186, // 168: groundplane.agent.v1.ExecutionStep.service_proxy_probe:type_name -> groundplane.agent.v1.ServiceProxyProbe
	187, // 169: groundplane.agent.v1.ExecutionStep.service_proxy_compensate:type_name -> groundplane.agent.v1.ServiceProxyCompensate
	189, // 170: groundplane.agent.v1.ExecutionStep.service_recreate_acknowledge:type_name -> groundplane.agent.v1.ServiceRecreateAcknowledge
	190, // 171: groundplane.agent.v1.ExecutionStep.service_recreate_probe:type_name -> groundplane.agent.v1.ServiceRecreateProbe
	191, // 172: groundplane.agent.v1.ExecutionStep.service_recreate_compensate:type_name -> groundplane.agent.v1.ServiceRecreateCompensate
	196, // 173: groundplane.agent.v1.ExecutionStep.managed_volume_remove:type_name -> groundplane.agent.v1.ManagedVolumeRemove
	197, // 174: groundplane.agent.v1.ExecutionStep.managed_volume_directory_remove:type_name -> groundplane.agent.v1.ManagedVolumeDirectoryRemove
	201, // 175: groundplane.agent.v1.ExecutionStep.component_apply:type_name -> groundplane.agent.v1.ComponentApply
	202, // 176: groundplane.agent.v1.ExecutionStep.host_resolution_apply:type_name -> groundplane.agent.v1.HostResolutionApply
	203, // 177: groundplane.agent.v1.ExecutionStep.host_resolution_restore:type_name -> groundplane.agent.v1.HostResolutionRestore
	126, // 178: groundplane.agent.v1.ExecutionStep.run_script:type_name -> groundplane.agent.v1.RunScript
	116, // 179: groundplane.agent.v1.ExecutionStep.candidate_restoration_probe:type_name -> groundplane.agent.v1.CandidateRestorationProbe
	117, // 180: groundplane.agent.v1.ExecutionStep.candidate_restoration_compensate:type_name -> groundplane.agent.v1.CandidateRestorationCompensate
	124, // 181: groundplane.agent.v1.ExecutionStep.managed_network_ensure:type_name -> groundplane.agent.v1.ManagedNetworkEnsure
	125, // 182: groundplane.agent.v1.ExecutionStep.managed_volume_ensure:type_name -> groundplane.agent.v1.ManagedVolumeEnsure
	100, // 183: groundplane.agent.v1.ExecutionStep.backing_hook_procedure:type_name -> groundplane.agent.v1.BackingHookProcedure
	23,  // 184: groundplane.agent.v1.ExecutionStep.policy:type_name -> groundplane.agent.v1.ExecutionStepPolicy
	131, // 185: groundplane.agent.v1.ResolvedRunnerSnapshot.networks:type_name -> groundplane.agent.v1.ScriptRunnerNetwork
	133, // 186: groundplane.agent.v1.ResolvedRunnerSnapshot.mounts:type_name -> groundplane.agent.v1.ScriptRunnerMount
	138, // 187: groundplane.agent.v1.ResolvedRunnerSnapshot.entry_bindings:type_name -> groundplane.agent.v1.ScriptRunnerEntryBinding
	139, // 188: groundplane.agent.v1.ResolvedRunnerSnapshot.secret_values:type_name -> groundplane.agent.v1.ScriptRunnerSecretValue
	134, // 189: groundplane.agent.v1.ResolvedRunnerSnapshot.service_source:type_name -> groundplane.agent.v1.ScriptSourceAuthority
	134, // 190: groundplane.agent.v1.ResolvedRunnerSnapshot.network_topology_source:type_name -> groundplane.agent.v1.ScriptSourceAuthority
	134, // 191: groundplane.agent.v1.ResolvedRunnerSnapshot.applied_environment_source:type_name -> groundplane.agent.v1.ScriptSourceAuthority
	128, // 192: groundplane.agent.v1.ResolvedRunnerSnapshot.explicit_execution:type_name -> groundplane.agent.v1.ScriptExplicitExecutionAuthority
	129, // 193: groundplane.agent.v1.ScriptExplicitExecutionAuthority.context:type_name -> groundplane.agent.v1.ScriptExplicitExecutionContext
	130, // 194: groundplane.agent.v1.ScriptExplicitExecutionContext.volumes:type_name -> groundplane.agent.v1.ScriptExplicitVolumeGrant
	132, // 195: groundplane.agent.v1.ScriptRunnerNetwork.rendered_attachment:type_name -> groundplane.agent.v1.ScriptNetworkAttachment
	134, // 196: groundplane.agent.v1.ScriptRunnerNetwork.source:type_name -> groundplane.agent.v1.ScriptSourceAuthority
	141, // 197: groundplane.agent.v1.ScriptNetworkAttachment.driver_options:type_name -> groundplane.agent.v1.ScriptStringPair
	137, // 198: groundplane.agent.v1.ScriptRunnerMount.rendered_mount:type_name -> groundplane.agent.v1.ScriptMount
	134, // 199: groundplane.agent.v1.ScriptRunnerMount.source:type_name -> groundplane.agent.v1.ScriptSourceAuthority
	135, // 200: groundplane.agent.v1.ScriptSourceAuthority.existing:type_name -> groundplane.agent.v1.ScriptExistingSourceAuthority
	136, // 201: groundplane.agent.v1.ScriptSourceAuthority.staged:type_name -> groundplane.agent.v1.ScriptStagedSourceAuthority
	22,  // 202: groundplane.agent.v1.ScriptRunnerEntryBinding.kind:type_name -> groundplane.agent.v1.ScriptEntryBindingKind
	141, // 203: groundplane.agent.v1.ScriptRunnerProjection.environment:type_name -> groundplane.agent.v1.ScriptStringPair
	141, // 204: groundplane.agent.v1.ScriptRunnerProjection.sysctls:type_name -> groundplane.agent.v1.ScriptStringPair
	142, // 205: groundplane.agent.v1.ScriptRunnerProjection.ulimits:type_name -> groundplane.agent.v1.ScriptUlimit
	143, // 206: groundplane.agent.v1.ScriptRunnerProjection.blkio:type_name -> groundplane.agent.v1.ScriptBlkio
	141, // 207: groundplane.agent.v1.ScriptRunnerProjection.storage_opt:type_name -> groundplane.agent.v1.ScriptStringPair
	146, // 208: groundplane.agent.v1.ScriptRunnerProjection.limits:type_name -> groundplane.agent.v1.ScriptResource
	146, // 209: groundplane.agent.v1.ScriptRunnerProjection.reservations:type_name -> groundplane.agent.v1.ScriptResource
	133, // 210: groundplane.agent.v1.ScriptRunnerProjection.mounts:type_name -> groundplane.agent.v1.ScriptRunnerMount
	131, // 211: groundplane.agent.v1.ScriptRunnerProjection.networks:type_name -> groundplane.agent.v1.ScriptRunnerNetwork
	141, // 212: groundplane.agent.v1.ScriptRunnerProjection.labels:type_name -> groundplane.agent.v1.ScriptStringPair
	138, // 213: groundplane.agent.v1.ScriptRunnerProjection.entry_bindings:type_name -> groundplane.agent.v1.ScriptRunnerEntryBinding
	144, // 214: groundplane.agent.v1.ScriptBlkio.weight_devices:type_name -> groundplane.agent.v1.ScriptWeightDevice
	145, // 215: groundplane.agent.v1.ScriptBlkio.device_read_bps:type_name -> groundplane.agent.v1.ScriptThrottleDevice
	145, // 216: groundplane.agent.v1.ScriptBlkio.device_read_iops:type_name -> groundplane.agent.v1.ScriptThrottleDevice
	145, // 217: groundplane.agent.v1.ScriptBlkio.device_write_bps:type_name -> groundplane.agent.v1.ScriptThrottleDevice
	145, // 218: groundplane.agent.v1.ScriptBlkio.device_write_iops:type_name -> groundplane.agent.v1.ScriptThrottleDevice
	149, // 219: groundplane.agent.v1.ScriptAssignmentArtifacts.bodies:type_name -> groundplane.agent.v1.ScriptBodyArtifact
	150, // 220: groundplane.agent.v1.ScriptAssignmentArtifacts.secrets:type_name -> groundplane.agent.v1.ScriptSecretArtifact
	151, // 221: groundplane.agent.v1.ScriptAssignmentArtifacts.entries:type_name -> groundplane.agent.v1.ScriptEntryArtifact
	147, // 222: groundplane.agent.v1.ScriptBodyArtifact.metadata:type_name -> groundplane.agent.v1.ScriptBodyArtifactMetadata
	138, // 223: groundplane.agent.v1.ScriptEntryArtifact.binding:type_name -> groundplane.agent.v1.ScriptRunnerEntryBinding
	25,  // 224: groundplane.agent.v1.BackupSourceCapture.source_format:type_name -> groundplane.agent.v1.BackupSourceFormat
	26,  // 225: groundplane.agent.v1.BackupSourceCapture.encryption:type_name -> groundplane.agent.v1.BackupEncryption
	155, // 226: groundplane.agent.v1.BackupSourceCapture.attach:type_name -> groundplane.agent.v1.BackupAttachSource
	156, // 227: groundplane.agent.v1.BackupSourceCapture.config:type_name -> groundplane.agent.v1.BackupConfigSource
	157, // 228: groundplane.agent.v1.BackupSourceCapture.volume:type_name -> groundplane.agent.v1.BackupVolumeSource
	153, // 229: groundplane.agent.v1.BackupSourceCapture.upload:type_name -> groundplane.agent.v1.BackupUploadAuthority
	24,  // 230: groundplane.agent.v1.BackupUploadAuthority.connector_addressing:type_name -> groundplane.agent.v1.BackupS3Addressing
	24,  // 231: groundplane.agent.v1.BackupArtifactPrune.connector_addressing:type_name -> groundplane.agent.v1.BackupS3Addressing
	158, // 232: groundplane.agent.v1.BackupVolumeSource.services:type_name -> groundplane.agent.v1.BackupVolumeService
	27,  // 233: groundplane.agent.v1.BackupVolumeService.prior_intent:type_name -> groundplane.agent.v1.BackupServiceRuntimeIntent
	29,  // 234: groundplane.agent.v1.BackupCheckpointRequest.kind:type_name -> groundplane.agent.v1.BackupCheckpointKind
	165, // 235: groundplane.agent.v1.BackupCheckpointRequest.artifact_prepared:type_name -> groundplane.agent.v1.BackupArtifactPreparedCheckpoint
	167, // 236: groundplane.agent.v1.BackupCheckpointRequest.upload_verified:type_name -> groundplane.agent.v1.BackupUploadVerifiedCheckpoint
	168, // 237: groundplane.agent.v1.BackupCheckpointRequest.source_cleanup_completed:type_name -> groundplane.agent.v1.BackupSourceCleanupCompletedCheckpoint
	169, // 238: groundplane.agent.v1.BackupCheckpointRequest.restore_artifact_validated:type_name -> groundplane.agent.v1.BackupRestoreArtifactValidatedCheckpoint
	170, // 239: groundplane.agent.v1.BackupCheckpointRequest.volume_tree_staged:type_name -> groundplane.agent.v1.BackupVolumeTreeStagedCheckpoint
	171, // 240: groundplane.agent.v1.BackupCheckpointRequest.volume_tree_exchanged:type_name -> groundplane.agent.v1.BackupVolumeTreeExchangedCheckpoint
	172, // 241: groundplane.agent.v1.BackupCheckpointRequest.volume_replaced_tree_cleaned:type_name -> groundplane.agent.v1.BackupVolumeReplacedTreeCleanedCheckpoint
	173, // 242: groundplane.agent.v1.BackupCheckpointRequest.config_generation_staged:type_name -> groundplane.agent.v1.BackupConfigGenerationStagedCheckpoint
	174, // 243: groundplane.agent.v1.BackupCheckpointRequest.config_generation_activated:type_name -> groundplane.agent.v1.BackupConfigGenerationActivatedCheckpoint
	175, // 244: groundplane.agent.v1.BackupCheckpointRequest.postgres_restore_verified:type_name -> groundplane.agent.v1.BackupPostgresRestoreVerifiedCheckpoint
	176, // 245: groundplane.agent.v1.BackupCheckpointRequest.remote_object_absent:type_name -> groundplane.agent.v1.BackupRemoteObjectAbsentCheckpoint
	166, // 246: groundplane.agent.v1.BackupCheckpointRequest.upload_completed:type_name -> groundplane.agent.v1.BackupUploadCompletedCheckpoint
	28,  // 247: groundplane.agent.v1.BackupSecretSlotTransfer.purpose:type_name -> groundplane.agent.v1.BackupSecretSlotPurpose
	162, // 248: groundplane.agent.v1.BackupSecretSlotTransfer.header:type_name -> groundplane.agent.v1.BackupSecretSlotHeader
	163, // 249: groundplane.agent.v1.BackupSecretSlotTransfer.chunk:type_name -> groundplane.agent.v1.BackupSecretSlotChunk
	164, // 250: groundplane.agent.v1.BackupSecretSlotTransfer.end:type_name -> groundplane.agent.v1.BackupSecretSlotEnd
	30,  // 251: groundplane.agent.v1.AdapterProcedure.phase:type_name -> groundplane.agent.v1.AdapterProcedurePhase
	31,  // 252: groundplane.agent.v1.AdapterProcedure.authentication:type_name -> groundplane.agent.v1.BackingAuthentication
	32,  // 253: groundplane.agent.v1.MaterializeFile.output_kind:type_name -> groundplane.agent.v1.MaterializationOutputKind
	33,  // 254: groundplane.agent.v1.ManagedConfigHelperRequest.operation:type_name -> groundplane.agent.v1.ManagedConfigOperation
	33,  // 255: groundplane.agent.v1.ManagedConfigHelperResponse.operation:type_name -> groundplane.agent.v1.ManagedConfigOperation
	34,  // 256: groundplane.agent.v1.ManagedConfigHelperResponse.disposition:type_name -> groundplane.agent.v1.ManagedConfigReplayDisposition
	103, // 257: groundplane.agent.v1.EnvironmentDirectoryHelperRequest.plan:type_name -> groundplane.agent.v1.ExecutionPlan
	103, // 258: groundplane.agent.v1.ComposeHelperRequest.plan:type_name -> groundplane.agent.v1.ExecutionPlan
	88,  // 259: groundplane.agent.v1.ComposeHelperRequest.restoration_authority:type_name -> groundplane.agent.v1.ReleaseRestorationAuthority
	35,  // 260: groundplane.agent.v1.ComposeHelperResponse.outcome:type_name -> groundplane.agent.v1.ComposeHelperOutcome
	36,  // 261: groundplane.agent.v1.ComposeHelperResponse.diagnostic:type_name -> groundplane.agent.v1.ComposeHelperDiagnostic
	188, // 262: groundplane.agent.v1.ComposeHelperResponse.proxy_evidence:type_name -> groundplane.agent.v1.ServiceProxyEvidence
	192, // 263: groundplane.agent.v1.ComposeHelperResponse.recreate_evidence:type_name -> groundplane.agent.v1.ServiceRecreateEvidence
	63,  // 264: groundplane.agent.v1.ComposeHelperResponse.candidate_absence_evidence:type_name -> groundplane.agent.v1.CandidateAbsenceEvidence
	38,  // 265: groundplane.agent.v1.ConfigUpdate.agent_config:type_name -> groundplane.agent.v1.AgentConfig
	39,  // 266: groundplane.agent.v1.AgentChannel.Connect:input_type -> groundplane.agent.v1.AgentMessage
	69,  // 267: groundplane.agent.v1.AgentChannel.Connect:output_type -> groundplane.agent.v1.ControllerMessage
...
func file_proto_agent_proto_init() {
	...
	file_proto_agent_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*AgentMessage_WorkloadImageResolutionResult)(nil),
	...
	file_proto_agent_proto_msgTypes[32].OneofWrappers = []any{
		...
		(*ControllerMessage_ResolveWorkloadImages)(nil),
		(*ControllerMessage_VolumeRemovalCheckpointAck)(nil),
		(*ControllerMessage_ObserveServices)(nil),
		(*ControllerMessage_CancelServiceObservation)(nil),
		(*ControllerMessage_BackingHookCheckpointAck)(nil),
		(*ControllerMessage_TaskEventAck)(nil),
	}
	file_proto_agent_proto_msgTypes[39].OneofWrappers = []any{
	...
	file_proto_agent_proto_msgTypes[56].OneofWrappers = []any{}
	...
	file_proto_agent_proto_msgTypes[86].OneofWrappers = []any{
		...
		(*ExecutionStep_CandidateRestorationProbe)(nil),
		(*ExecutionStep_CandidateRestorationCompensate)(nil),
		(*ExecutionStep_ManagedNetworkEnsure)(nil),
		(*ExecutionStep_ManagedVolumeEnsure)(nil),
		(*ExecutionStep_BackingHookProcedure)(nil),
	}
	file_proto_agent_proto_msgTypes[103].OneofWrappers = []any{}
	file_proto_agent_proto_msgTypes[115].OneofWrappers = []any{
