...
var agentProcedures = map[ActionKind]string{ActionAttachGrantRevoke: "attach.grant-revoke", ActionAttachDetach: "attach.detach", ActionEnvironmentAgentCleanup: "environment.cleanup", ActionServiceRemove: "service.remove", ActionEntryRemove: "entry.remove", ActionRouteRemove: "route.remove", ActionComponentRemove: "component.remove", ActionMaterializationRemove: "materialization.remove", ActionVolumeAgentCleanup: "volume.cleanup", ActionZoneRemove: "zone.remove", ActionNetworkRemove: "network.remove", ActionRecoveryPointRemove: "recovery-point.remove", ActionOrphanObjectRemove: "orphan-object.remove", ActionBackingRuntimeReconstruct: "backing.runtime-reconstruct"}
var controllerFinalizers = map[ActionKind]string{ActionScriptRemove: "script.remove", ActionReleaseGroupRemove: "release-group.remove", ActionReleaseFinalize: "release.finalize", ActionBackupPolicyFinalize: "backup-policy.finalize", ActionKeyMaterialRemove: "key-material.remove", ActionVolumeFinalize: "volume.finalize", ActionReservationRelease: "reservation.release", ActionConnectorFinalize: "connector.finalize", ActionEnvironmentFinalize: "environment.finalize", ActionRunnerLocalRemove: "runner.remove", ActionProjectSecretRemove: "secret.remove", ActionBackingServiceFinalize: "backing.finalize", ActionProjectFinalize: "project.finalize", ActionTenantFinalize: "tenant.finalize"}
