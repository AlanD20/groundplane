...
func resolveMaterializationForTest(
	...
	step := &agentpb.ExecutionStep{
		StepId: resolverStepID,
		Payload: &agentpb.ExecutionStep_MaterializeFile{MaterializeFile: &agentpb.MaterializeFile{
			EnvironmentId: resolverEnvironmentID, Length: uint64(len(expected)), Sha256: digest[:],
		}},
	}
	...
	task := etcd.TaskRecord{
		...
		Materializations: []etcd.TaskMaterializationRecord{{
			StepID: resolverStepID, EnvironmentID: resolverEnvironmentID, Source: sourceReference,
		}},
	}
