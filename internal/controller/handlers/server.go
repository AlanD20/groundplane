// Package handlers owns the Controller's HTTP boundary: request validation,
// public response projection, streaming and Console asset delivery. Capability
// services own the operations invoked by these routes.
package handlers
