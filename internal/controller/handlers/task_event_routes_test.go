...
func TestTaskEventRouteStreamsTypedSequenceFrames(t *testing.T) {
	...
	opener := &fakeTaskEventStreamOpener{runner: fakeTaskEventRunner{events: []testtaskjournal.TaskEventRecord{{
		Sequence: 4,
		...
		State: testtaskjournal.TaskEventStateRunning, ReceivedAt: receivedAt,
	}}}}
...
func TestTaskEventRouteDisconnectsSafelyAfterHeaders(t *testing.T) {
	...
	opener := &fakeTaskEventStreamOpener{runner: fakeTaskEventRunner{
		events: []testtaskjournal.TaskEventRecord{{
			Sequence: 1,
			Identity: testtaskjournal.TaskEventIdentity{
...
func (runner fakeTaskEventRunner) Run(
	ctx context.Context,
	emit func(testtaskjournal.TaskEventRecord) error,
) error {
