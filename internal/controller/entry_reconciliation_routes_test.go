...
func TestEntryReadExposesBlueprintReconciliationKey(t *testing.T) {
	...
	record := etcd.EntryRecord{EnvironmentID: environmentID, BlueprintKey: "tls-seed", Entry: core.EnvEntry{
	...
	reader := &fakeEntryReader{record: etcd.Versioned[etcd.EntryRecord]{Record: record}}
