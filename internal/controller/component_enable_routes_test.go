...
func (*componentEnableRouteFixture) DisableComponent(
	...
	return etcd.IdempotencyResponse{}, errs.New(errs.KindInternal, "unexpected disable")
}

func (*componentEnableRouteFixture) UpdateComponent(context.Context, string, string) (etcd.IdempotencyResponse, error) {
	return etcd.IdempotencyResponse{}, errs.New(errs.KindInternal, "unexpected update")
}
...
func (*componentEnableRouteFixture) SetComponentConfig(
	...
	return etcd.IdempotencyResponse{}, errs.New(errs.KindInternal, "unexpected configure")
}
