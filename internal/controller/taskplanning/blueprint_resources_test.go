...
func TestProjectServiceProjectionPreservesStableTopology(t *testing.T) {
	...
	services, err := ProjectServiceProjection(project, testcomposeidentity.Snapshot{
...
func TestProjectServiceProjectionCanonicalizesIdentityOrder(t *testing.T) {
	...
	identities := []testcomposeidentity.Resource{
		{ID: workerID, Name: "worker"},
		{ID: apiID, Name: "api"},
	}

	services, err := ProjectServiceProjection(
		project, testcomposeidentity.Snapshot{Services: identities}, nil,
	)
	if err != nil {
		t.Fatalf("ProjectServiceProjection() error = %v", err)
	}
...
func TestProjectServiceProjectionCarriesTypedGroundplaneServiceExtensions(t *testing.T) {
	...
	services, err := ProjectServiceProjection(
		project,
		testcomposeidentity.Snapshot{Services: []testcomposeidentity.Resource{{ID: serviceID, Name: "api"}}},
