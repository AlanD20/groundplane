...
func TestAppendEnvironmentComponentTaskContributionRequiresComposeFirst(t *testing.T) {
	...
	steps, records, err := AppendEnvironmentComponentTaskContribution(
		...
		[]testtaskjournal.TaskStepRecord{{Kind: testtaskjournal.TaskStepOperation, ID: composeID}},
		[]*agentpb.ExecutionStep{activate},
		[]testtaskjournal.TaskStepRecord{{Kind: testtaskjournal.TaskStepOperation, ID: activateID}},
	)
	if err != nil {
