...
func (values *explicitScriptEntryValues) ResolveTaskMaterializationSource(
	_ context.Context, _ string, source testtaskmaterialization.Source,
) ([]byte, error) {
...
func TestExplicitScriptEntriesRejectInvalidResourcesBeforeValueReads(t *testing.T) {
	for _, test := range []struct {
		name string
		edit func(*testscriptsourcequeries.ScriptExecutionSources)
	}{
		{"missing Entry", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries = s.DesiredProjection.Record.Entries[:1]
		}},
		{"foreign Entry", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries[1].EnvironmentID = "env_01ARZ3NDEKTSV4RRFFQ69G5FAW"
		}},
		{"unexposed Entry", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries[1].Entry.Exposure = []string{"other"}
		}},
		{"duplicate Entry primary", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries = append(s.DesiredProjection.Record.Entries, s.DesiredProjection.Record.Entries[1])
		}},
		{"missing Volume", func(s *testscriptsourcequeries.ScriptExecutionSources) { s.DesiredProjection.Record.Volumes = nil }},
		{"duplicate Volume identity", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Volumes = append(s.DesiredProjection.Record.Volumes, s.DesiredProjection.Record.Volumes[0])
		}},
		{"foreign projection", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.EnvironmentID = "env_01ARZ3NDEKTSV4RRFFQ69G5FAW"
		}},
		{"foreign Script", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.Script.Record.ServiceID = "svc_01ARZ3NDEKTSV4RRFFQ69G5FAW"
		}},
		{"overlapping Volume", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.Script.Record.Desired.Execution.Volumes[0].Target = "/etc/tls"
		}},
		{"runner body", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries[1].Entry.Path = "groundplane-script-body"
		}},
		{"reserved interpreter", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries[1].Entry.Path = "bin/sh"
		}},
		{"traversal", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries[1].Entry.Path = "etc/../setup.conf"
		}},
		{"missing ownership", func(s *testscriptsourcequeries.ScriptExecutionSources) {
			s.DesiredProjection.Record.Entries[1].Entry.UID = nil
		}},
		{"overlapping Entry files", func(s *testscriptsourcequeries.ScriptExecutionSources) {
...
func explicitScriptEntrySources() testscriptsourcequeries.ScriptExecutionSources {
