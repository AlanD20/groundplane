...
type fakeConnectorCreationRepository struct {
	...
	resolveCalls int
	createCalls  int
	record       testconnectors.Record
	credentials  testconnectors.EncryptedCredentials
...
func (repository *fakeConnectorCreationRepository) ResolveSecret(
	...
	return testkeyvalue.Versioned[testsecrets.Record]{Record: testsecrets.Record{Secret: core.Secret{
...
func (*fakeConnectorCreationIdempotency) NewMarker(
	...
	return testidempotency.IdempotencyMarker{Locator: locator, Response: response}, nil
}
