...
func TestControllerTaskHandlerRejectsInvalidAgentRemovalParameters(t *testing.T) {
	...
	for name, params := range map[string]map[string]string{
		"missing resource": {},
		"wrong resource":   {testtaskjournal.TaskResourceKindParam: "service"},
		"extra parameter":  {testtaskjournal.TaskResourceKindParam: testtaskjournal.TaskResourceAgent, "unexpected": "value"},
	} {
...
func validAgentRemovalTask() etcd.TaskRecord {
	return etcd.TaskRecord{
		...
		Params:   map[string]string{testtaskjournal.TaskResourceKindParam: testtaskjournal.TaskResourceAgent},
	}
}
