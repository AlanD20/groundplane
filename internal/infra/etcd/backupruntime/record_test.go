...
func TestBackupRuntimeRecordCodecsRoundTrip(t *testing.T) {
	...
	tests := []struct {
		...
		{"due outcome", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupDueOutcomeRecord, DecodeBackupDueOutcomeRecord,
			)
		}},
		{"mutation epoch", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeEnvironmentMutationEpochRecord, DecodeEnvironmentMutationEpochRecord,
			)
		}},
		{"operation lock", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupOperationLockRecord, DecodeBackupOperationLockRecord,
			)
		}},
		{"source-target exclusion", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupSourceTargetExclusionRecord, DecodeBackupSourceTargetExclusionRecord,
			)
		}},
		{"backup run", func(t *testing.T) {
			record := testBackupRun(createdAt, updatedAt, recipient)
			record.RetentionKeep = testbackuppolicy.MaximumBackupPolicyKeep
		...
		{"recovery point", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupRecoveryPointRecord, DecodeBackupRecoveryPointRecord,
			)
		}},
		{"orphan", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupOrphanRecord, DecodeBackupOrphanRecord,
			)
		...
		{"retention", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupRetentionSweepRecord, DecodeBackupRetentionSweepRecord,
			)
			record.Keep++
		...
		{"prune", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupRecoveryPointPruneRecord, DecodeBackupRecoveryPointPruneRecord,
			)
		}},
		{"prune dispatch", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t, record, EncodeBackupRecoveryPointPruneDispatchRecord, DecodeBackupRecoveryPointPruneDispatchRecord,
			)
		}},
		...
		{"key rotation", func(t *testing.T) {
			...
			assertBackupCodecRoundTrip(
				t,
				record, EncodeBackupKeyRotationRecord, DecodeBackupKeyRotationRecord,
			)
		}},
	}
