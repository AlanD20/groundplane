...
func (ledger *ReleaseLedger) GetPlanningAppliedProjection(
	...
	if read == nil || read.ReadRevision != scope.ReadRevision || len(read.Values) != 1 {
		return etcdstore.Versioned[EnvironmentComposeProjection]{}, false, corruptReleaseRecord()
	}
	if read.Values[0] == nil {
		return etcdstore.Versioned[EnvironmentComposeProjection]{ReadRevision: scope.ReadRevision}, false, nil
	}
