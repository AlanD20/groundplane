...
func (repository *ConnectorRepository) CreateConnectorIdempotent(
	...
	if err := connectormutations.ValidateConnectorHierarchy(ctx, environment, project, record); err != nil {
	...
	plan, err := NewIdempotencyMutationPlan(
		...
		func(_ int64, values []*etcdstore.KeyValue) error {
			return connectormutations.ClassifyConnectorCreateConflict(values, fence, secretFence.ConditionCount())
		},
	)
	if err != nil {
		return IdempotencyTransactionResult{}, err
