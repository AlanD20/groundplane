...
func TestVolumeMutationPreservesAuthoredServicesWithoutExecutionLabels(t *testing.T) {
	...
	environment := etcd.EnvironmentRecord{ID: environmentID, VolumeDir: "/var/lib/groundplane/vol/test"}
	...
	current := etcd.EnvironmentComposeProjection{
		...
		DesiredServices:   []etcd.EnvironmentServiceProjection{{Desired: core.Service{ID: serviceID, Name: "app"}}},
	}
