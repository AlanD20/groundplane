...
func (service *MutationService) prepareRemoval(
	ctx context.Context, source etcd.Versioned[etcd.EnvironmentComposeProjection], request volumeMutationRequest,
	task *etcd.TaskRecord, marker etcd.IdempotencyMarker,
