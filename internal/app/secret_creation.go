...
func newDurableSecretCreationIdempotency(
	coordinator *idempotentintent.Coordinator,
	repository *etcd.IdempotencyRepository,
...
func (service *durableSecretCreationIdempotency) Prepare(
	...
	version, canonicalDigest, err := idempotentintent.Canonicalize(ctx, idempotentintent.CanonicalIntentV1{
		...
		Body: idempotentintent.JSONBody(idempotentintent.Object(
			...
			idempotentintent.Field{Name: "platform", Value: idempotentintent.Bool(input.Platform)},
