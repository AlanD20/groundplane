...
func TestHostSystemSourceAppliesLockedFormatting(t *testing.T) {
	...
	source := &hostSystemSnapshotSource{
...
func TestHostEtcdSourceProjectsSafeDependencyStates(t *testing.T) {
	...
	dbSize := int64(18 << 20)
	healthy := &hostEtcdSnapshotSource{
...
func TestHostAgentSourceUsesDurableOrBootstrapConfig(t *testing.T) {
	...
	absent := &hostAgentSnapshotSource{health: fakeHostAgentHealth{}, fallback: fallback}
	...
	present := &hostAgentSnapshotSource{health: fakeHostAgentHealth{health: []localagent.Health{{
