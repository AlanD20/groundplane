...
func TestLocalAgentSessionsAdapterTranslatesSnapshotAndReady(t *testing.T) {
	...
	adapter, err := newLocalAgentSessionsAdapter(registry)
	if err != nil {
		t.Fatalf("newLocalAgentSessionsAdapter() error = %v", err)
	}
...
func TestLocalAgentContainerAdapterTranslatesDesiredIdentity(t *testing.T) {
	...
	adapter, err := newLocalAgentContainerAdapter(lifecycle)
	if err != nil {
		t.Fatalf("newLocalAgentContainerAdapter() error = %v", err)
	}
