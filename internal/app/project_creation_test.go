...
func TestProjectCreationServicePersistsEffectiveInputAndExactResponse(t *testing.T) {
	...
	response, err := service.CreateProject(context.Background(), hierarchy.CreateProjectInput{
	...
	if repository.record != (etcd.ProjectRecord{
...
func TestProjectCreationServiceReplaysBeforeRepositoryAccess(t *testing.T) {
	...
	got, err := service.CreateProject(context.Background(), hierarchy.CreateProjectInput{
...
func projectCreationTestEvidence() projectCreationEvidence {
	...
	return projectCreationEvidence{durable: etcd.ProtectedIntentRecord{
