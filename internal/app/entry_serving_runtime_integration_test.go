...
func TestEntryMutationCapturesImmutableRevisionSource(t *testing.T) {
	testBlueprintExecutedArtifact(t, true, false, func(fixture *ExecutedArtifactFixture,
		...
		AssertAttachRuntimeRoundTrip(t, captured.Projection, captured.EpochRevision, captured.RunningServiceIDs)
...
func testEntryMutationServingRuntime(
	...
	testBlueprintExecutedArtifactConfigured(t, true, false, configure, func(fixture *ExecutedArtifactFixture,
