...
func newVolumeRemovalProductionJourney(t *testing.T) (
	*volumeRemovalProductionFixture, *volume.MutationService, *volume.ReadService, api.VolumeMutationResponse,
) {
	t.Helper()
...
func newPendingVolumeProductionJourney(t *testing.T, existing ...*volumeRemovalProductionFixture) (
	*volumeRemovalProductionFixture, *volume.MutationService, *volume.ReadService, api.VolumeMutationResponse,
) {
	t.Helper()
	var fixture *volumeRemovalProductionFixture
	if len(existing) != 0 {
		fixture = existing[0]
	} else {
