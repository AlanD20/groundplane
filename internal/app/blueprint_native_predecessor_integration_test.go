...
func TestBlueprintCandidateAfterNativeRollbackUsesSealedPredecessor(t *testing.T) {
	testBlueprintExecutedArtifact(
		...
		true,
		false,
		func(fixture *ExecutedArtifactFixture, resolver *testtaskplanning.TaskPlanResolver, original testreleaserender.ReleaseRenderInput, intent domain.Intent, applied *agentpb.ComposeArtifact) {
