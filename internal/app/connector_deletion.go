...
func newDurableConnectorDeletionIdempotency(
	coordinator *idempotentintent.Coordinator,
	repository *etcd.IdempotencyRepository,
...
func (service *durableConnectorDeletionIdempotency) Prepare(
	...
	version, digest, err := idempotentintent.Canonicalize(ctx, idempotentintent.CanonicalIntentV1{
		...
		Path:  []idempotentintent.PathBinding{{Name: "id", Value: connectorID}},
...
func newConnectorDeletionService(
	repository connectorDeletionRepository,
	idempotency connectorDeletionIdempotency,
...
func newDurableConnectorDeletionRepository(
	hierarchy *etcd.HierarchyRepository,
	connectors *etcd.ConnectorRepository,
