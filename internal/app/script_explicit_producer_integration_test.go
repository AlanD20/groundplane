...
func explicitProducerInput(
	t *testing.T,
) (*ManualScriptAdmissionFixture, testtaskplanning.ManualScriptPlanInput, *explicitProducerPorts) {
	t.Helper()
	fixture := NewExplicitManualScriptAdmissionFixture(t, core.ScriptExecution{
