...
| BP-02 | Validate a proposed create/update/removal against existing resources. | Accurate create/update/remove/retain diff and zero desired, Task, runtime or data writes. | PARTIAL H70: selected Entry create/remove and Volume omission refusal; unchanged resources reported update |
